...
export const building: SubjectCurriculum = {
  ...
  topics: [
    ...
    { name: "Plumbing Basics", description: "Pipes, taps, water supply and unblocking drains.", difficulty: "intermediate" },
    { name: "Outdoor Projects", description: "Fences, gates, decks and garden structures.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== BLUEPRINTS (4) =====================
    {
    ...
    // ===================== PLUMBING BASICS (4) =====================
    {
      topic: "Plumbing Basics",
      title: "Pipes & Water Supply",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Clean water comes in through pipes under pressure; waste water leaves through drain pipes.",
      blocks: [
        { type: "heading", text: "Water In, Water Out" },
        { type: "text", text: "A home's plumbing has two systems. The SUPPLY side brings clean water IN under pressure through strong pipes (so it reaches your taps and shower head). The WASTE side carries dirty water AWAY by gravity through bigger drain pipes, with curved 'U-bends' (traps) that hold a little water to block smelly sewer gases.\n\nSupply pipes are usually copper or plastic; waste pipes are plastic. Knowing which is which keeps you safe — never drink from a waste pipe!" },
        { type: "example", text: "Under a sink, the U-bend (trap) holds a plug of water that stops sewer smells coming up into the room — that's why drains don't usually stink." },
        { type: "keyPoints", items: ["Supply = clean water in (under pressure).", "Waste = dirty water out (by gravity).", "Traps (U-bends) block sewer gases.", "Copper/plastic supply; plastic waste."] },
        match(["Supply pipes", "Clean water in (pressure)"], ["Waste pipes", "Dirty water out (gravity)"], ["Trap / U-bend", "Blocks sewer gases"], ["Copper", "Common supply material"]),
      ],
      questions: [
        { q: "Clean water comes in under…", options: ["pressure", "gravity only", "vacuum", "heat"], answer: "pressure", explain: "So it reaches taps." },
        { q: "Waste water leaves by…", options: ["gravity", "pressure", "magic", "pumps only"], answer: "gravity", explain: "Flows down + out." },
        { q: "A U-bend (trap)…", options: ["blocks sewer gases", "makes water hot", "filters water", "stops the water"], answer: "blocks sewer gases", explain: "Holds a plug of water." },
        { q: "Supply pipes are often made of…", options: ["copper or plastic", "wood", "paper", "rubber only"], answer: "copper or plastic", explain: "Strong + clean." },
        { q: "You should never…", options: ["drink from a waste pipe", "turn a tap", "use a sink", "wash hands"], answer: "drink from a waste pipe", explain: "It carries dirty water." },
      ],
    },
    {
      topic: "Plumbing Basics",
      ...
      minutes: 12,
      points: 80,
      summary: "A dripping tap is usually a worn washer; turn off the water before taking a tap apart.",
      blocks: [
        { type: "heading", text: "Fix That Drip" },
        { type: "text", text: "A dripping tap wastes surprising amounts of water and is usually caused by a worn WASHER — a small rubber ring inside the tap that seals the water off. Replacing it fixes most drips.\n\nThe golden rule: TURN OFF THE WATER (the isolation valve under the sink, or the main stop valve) before undoing any tap — otherwise you'll flood the room. Then open the tap to drain what's left, take it apart, swap the washer, and reassemble." },
        { type: "example", text: "A tap dripping once a second wastes thousands of litres a year — fixing a 5p washer can save a small lake." },
        { type: "keyPoints", items: ["Drips = usually a worn washer.", "Turn off the water FIRST.", "Drain the tap before undoing.", "Swap the washer + reassemble."] },
        ord(["Turn off the water supply", "Open the tap to drain", "Take the tap apart", "Swap the worn washer", "Reassemble + turn water back on"]),
      ],
      questions: [
        { q: "A dripping tap is usually caused by…", options: ["a worn washer", "too much water", "the sink", "the floor"], answer: "a worn washer", explain: "A rubber seal inside." },
        { q: "Before undoing a tap you MUST…", options: ["turn off the water", "turn on the water", "boil the tap", "break the pipe"], answer: "turn off the water", explain: "Or you'll flood." },
        { q: "After turning off the water, open the tap to…", options: ["drain what's left", "let more in", "make it louder", "nothing"], answer: "drain what's left", explain: "Empty the pipe." },
        { q: "Fixing a worn washer can save…", options: ["thousands of litres a year", "no water", "electricity", "time only"], answer: "thousands of litres a year", explain: "A drip adds up." },
        { q: "A washer is…", options: ["a small rubber ring", "a big pipe", "a tap handle", "a type of glue"], answer: "a small rubber ring", explain: "It seals the water." },
      ],
    },
    {
      topic: "Plumbing Basics",
      ...
      minutes: 12,
      points: 80,
      summary: "Blocked drains are often fat, hair or food; use a plunger and never pour grease down a sink.",
      blocks: [
        { type: "heading", text: "When Water Won't Go" },
        { type: "text", text: "A slow or blocked drain is usually a build-up of FAT (cooking oil), HAIR, or FOOD scraps. The first fix is a PLUNGER — a rubber cup that pushes and pulls the blockage loose with suction. Stubborn blocks may need a plumber's snake (a flexible coil).\n\nPrevention beats cure: NEVER pour cooking fat down a sink (it sets like candle wax in the cold pipes). Put fat in a jar to solidify, then bin it. Use a plug strainer to catch hair and food." },
        { type: "example", text: "Pour hot bacon fat down the sink and it cools + sets in the pipes, slowly building a 'fatberg' that blocks everything. Bin it instead." },
        { type: "keyPoints", items: ["Blocks = fat, hair, food.", "First fix = a plunger.", "Snake for stubborn blocks.", "Never pour grease down a sink."] },
      ],
      questions: [
        { q: "The first tool to try on a blocked drain is a…", options: ["plunger", "hammer", "saw", "drill"], answer: "plunger", explain: "Suction shifts the block." },
        { q: "Never pour ___ down a sink.", options: ["cooking fat", "water", "soap", "tea"], answer: "cooking fat", explain: "It sets in cold pipes." },
        { q: "What causes most sink blocks?", options: ["fat, hair, food", "salt", "ice", "soap bubbles"], answer: "fat, hair, food", explain: "Build-up over time." },
        { q: "A plumber's ___ clears stubborn blocks.", options: ["snake (drain coil)", "fish", "hammer", "ruler"], answer: "snake (drain coil)", explain: "A flexible coil." },
        { q: "A plug strainer helps by…", options: ["catching hair + food", "adding fat", "blocking water", "making bubbles"], answer: "catching hair + food", explain: "Prevents blocks." },
      ],
    },
    {
      topic: "Plumbing Basics",
      ...
      minutes: 12,
      points: 80,
      summary: "A boiler heats water for taps and radiators; treat it with care and call a pro for gas faults.",
      blocks: [
        { type: "heading", text: "Where Hot Water Comes From" },
        { type: "text", text: "A BOILER burns gas (or uses electricity) to heat water, sending it to your hot taps and to RADIATORS that warm the rooms. The hot water is stored in a cylinder or heated on demand. A thermostat controls the temperature.\n\nGas boilers can be dangerous if faulty — they can leak CARBON MONOXIDE, a poison you can't see or smell. So any gas work MUST be done by a qualified engineer, and homes need a carbon-monoxide alarm near the boiler." },
        { type: "example", text: "Carbon monoxide has no colour or smell — a working alarm near the boiler is the only way to know it's there." },
        { type: "keyPoints", items: ["Boiler heats water for taps + radiators.", "Thermostat controls temperature.", "Gas faults can leak CO (poison).", "Only a qualified engineer fits gas."] },
      ],
      questions: [
        { q: "A boiler heats water for…", options: ["taps + radiators", "the garden only", "the car", "the roof"], answer: "taps + radiators", explain: "Hot water + heating." },
        { q: "Radiators…", options: ["warm the rooms", "cool the rooms", "store food", "make electricity"], answer: "warm the rooms", explain: "Hot water flows through." },
        { q: "A faulty gas boiler can leak…", options: ["carbon monoxide", "oxygen", "water only", "nothing"], answer: "carbon monoxide", explain: "A deadly, invisible gas." },
        { q: "Carbon monoxide is…", options: ["invisible + odourless", "blue + smelly", "yellow + loud", "cold"], answer: "invisible + odourless", explain: "Why alarms matter." },
        { q: "Gas work must be done by…", options: ["a qualified engineer", "anyone", "a child", "a chef"], answer: "a qualified engineer", explain: "It's dangerous." },
      ],
    },

    // ===================== OUTDOOR PROJECTS (4) =====================
    {
      topic: "Outdoor Projects",
      title: "Fences & Gates",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "A fence needs stout posts set deep in concrete; a gate hangs level from a strong post.",
      blocks: [
        { type: "heading", text: "Marking Your Boundary" },
        { type: "text", text: "A fence is only as strong as its POSTS. Posts go in holes ~60 cm deep and are set in CONCRETE so they don't wobble or rot. Use treated timber so it resists rot, and slope the concrete top so rain runs off, not pools against the wood.\n\nA GATE needs an extra-stout hanging post (it carries the weight every time it swings). Hang the gate with good hinges and check it's LEVEL so it swings freely without dragging." },
        { type: "example", text: "A gate post that's wobbly = a sagging gate that scrapes the ground. Set that post deep in concrete and the gate will swing for decades." },
        { type: "keyPoints", items: ["Posts set ~60 cm deep in concrete.", "Use treated timber (rot-resistant).", "Slope concrete so water runs off.", "Gate post must be extra-stout."] },
        ord(["Dig post holes ~60 cm deep", "Stand posts upright + level", "Pour concrete around posts", "Fix panels + hang the gate"]),
      ],
      questions: [
        { q: "A fence's strength comes mainly from…", options: ["the posts", "the paint", "the nails only", "the soil"], answer: "the posts", explain: "Set deep + concreted." },
        { q: "Posts are set in…", options: ["concrete", "sand", "water", "cardboard"], answer: "concrete", explain: "So they don't wobble." },
        { q: "Outdoor timber should be…", options: ["treated (rot-resistant)", "wet", "painted gold", "thin"], answer: "treated (rot-resistant)", explain: "To survive weather." },
        { q: "A gate needs an extra-stout…", options: ["hanging post", "paint colour", "name", "lock"], answer: "hanging post", explain: "It carries the weight." },
        { q: "Slope the concrete on a post so…", options: ["rain runs off, not pools", "it looks pretty", "it dries faster", "no reason"], answer: "rain runs off, not pools", explain: "Stops rot." },
      ],
    },
    {
      topic: "Outdoor Projects",
      ...
      minutes: 14,
      points: 90,
      summary: "A deck is a timber platform on joists; a patio is laid paving — both need a firm, level base.",
      blocks: [
        { type: "heading", text: "Outdoor Floors" },
        { type: "text", text: "A DECK is a raised timber floor: a frame of JOISTS (support beams) carries the boards, all sitting on firm posts. A PATIO is a ground-level floor of paving slabs or bricks laid on a bed of sand + hardcore (compacted rubble).\n\nBoth need a solid, LEVEL base and a slight slope so rain drains off, not pools. A wobbly deck or a rocking slab means the base wasn't firm enough — take the time to prepare." },
        { type: "example", text: "Lay paving slabs on a sloppy, soft base and they'll rock and crack within a year. Dig down, add compacted hardcore + sand, then lay level." },
        { type: "keyPoints", items: ["Deck = timber frame on joists.", "Patio = paving on sand + hardcore.", "Both need a firm, level base.", "Add a slight slope to drain rain."] },
      ],
      questions: [
        { q: "A deck is supported by…", options: ["joists (beams)", "soil only", "concrete only", "plastic"], answer: "joists (beams)", explain: "A timber frame." },
        { q: "Paving slabs are laid on…", options: ["sand + hardcore", "bare soil", "water", "concrete only"], answer: "sand + hardcore", explain: "A firm bed." },
        { q: "A wobbly deck usually means…", options: ["the base wasn't firm", "too much wood", "it's too old", "too short"], answer: "the base wasn't firm", explain: "Prepare the base well." },
        { q: "A deck or patio should have a slight…", options: ["slope to drain rain", "step at the door", "colour", "wall"], answer: "slope to drain rain", explain: "So water doesn't pool." },
        { q: "'Hardcore' in building means…", options: ["compacted rubble/base", "a tough person", "a type of paint", "soft sand"], answer: "compacted rubble/base", explain: "A firm foundation layer." },
      ],
    },
    {
      topic: "Outdoor Projects",
      ...
      minutes: 12,
      points: 80,
      summary: "Sheds, pergolas and raised beds extend your outdoor space; position for sun, shade and access.",
      blocks: [
        { type: "heading", text: "Buildings for the Garden" },
        { type: "text", text: "Common garden structures: a SHED (store tools + bikes), a PERGOLA (a timber frame for climbing plants to shade a path), and RAISED BEDS (timber or brick boxes of soil for easy gardening). Each needs a firm, level base and weather-proof materials.\n\nThink about position before building: a shed in deep shade stays damp; a veg bed wants SUN; a pergola gives shade where you sit. Measure twice, build once." },
        { type: "example", text: "A shed on bare soil will rot at the base and sink. Sit it on paving slabs or a concrete base so air can circulate and it stays dry." },
        { type: "keyPoints", items: ["Shed stores tools; pergola shades; raised beds garden.", "All need a firm, level base.", "Use weather-proof materials.", "Position for sun/shade/access."] },
      ],
      questions: [
        { q: "A shed is mainly for…", options: ["storage", "sleeping", "cooking", "swimming"], answer: "storage", explain: "Tools, bikes, etc." },
        { q: "A pergola is a frame for…", options: ["climbing plants + shade", "storing cars", "keeping animals", "rainwater"], answer: "climbing plants + shade", explain: "A shaded walkway." },
        { q: "A shed should sit on…", options: ["a firm, level base (slabs)", "bare soil", "grass only", "sand only"], answer: "a firm, level base (slabs)", explain: "Stops rot + sinking." },
        { q: "Vegetable beds want…", options: ["sun", "deep shade", "no soil", "concrete"], answer: "sun", explain: "Plants need light." },
        { q: "A pergola gives…", options: ["shade to sit under", "a roof for cars", "storage", "a cold spot"], answer: "shade to sit under", explain: "Climbing plants cover it." },
      ],
    },
    {
      topic: "Outdoor Projects",
      ...
      minutes: 12,
      points: 80,
      summary: "Outdoors: dig carefully (pipes/cables), wear gloves + boots, and don't work in storms.",
      blocks: [
        { type: "heading", text: "Safe Outside" },
        { type: "text", text: "Outdoor building has its own dangers. Before DIGGING, check for buried pipes and cables — a spade through a gas pipe or power cable is deadly. Wear sturdy BOOTS (dropped tools + toes don't mix), GLOVES, and eye protection when cutting.\n\nNever work in a STORM or high wind, especially on a deck, roof or with a ladder — lightning and falls kill. Keep tools dry and tidy so no one trips. Carry heavy loads with a straight back, bent knees." },
        { type: "example", text: "A spade hitting a buried electric cable can cause a fatal shock. Always check where services run before digging — call a service if unsure." },
        { type: "keyPoints", items: ["Check for buried pipes/cables before digging.", "Wear boots, gloves, eye protection.", "Never work in storms/high wind.", "Lift with bent knees, straight back."] },
      ],
      questions: [
        { q: "Before digging you should…", options: ["check for buried pipes/cables", "dig as fast as possible", "wear nothing", "ignore safety"], answer: "check for buried pipes/cables", explain: "Avoid deadly accidents." },
        { q: "Outdoors, always wear…", options: ["boots + gloves + eye protection", "sandals", "nothing on feet", "a suit"], answer: "boots + gloves + eye protection", explain: "Protect yourself." },
        { q: "Never work in a…", options: ["storm/high wind", "light drizzle", "sunshine", "morning"], answer: "storm/high wind", explain: "Lightning + falls." },
        { q: "A spade through a power cable can…", options: ["cause a fatal shock", "nothing", "make light", "be safe"], answer: "cause a fatal shock", explain: "Check first!" },
        { q: "To lift safely…", options: ["bend knees, keep back straight", "bend your back", "use one hand", "twist"], answer: "bend knees, keep back straight", explain: "Save your back." },
      ],
    },
  ],
};

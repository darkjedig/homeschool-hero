...
export const aics: SubjectCurriculum = {
  ...
  topics: [
    ...
    { name: "Loops & Functions", description: "Repeat actions and reuse code blocks.", difficulty: "intermediate" },
    { name: "Text & Data", description: "Work with strings, arrays and decisions in code.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== PROMPTS (4) =====================
    {
    ...
    // ===================== LOOPS & FUNCTIONS (6) =====================
    {
      ...
      minutes: 12,
      points: 80,
      summary: "Loops run the same block of code many times — for counting, lists, and animations.",
      blocks: [
        { type: "heading", text: "Do It Again (Efficiently)" },
        { type: "text", text: "Instead of copying the same line 100 times, use a loop. A 'for' loop repeats a set number of times. A 'while' loop repeats while a condition is true.\n\nLoops power everything from printing times tables to animating game frames." },
        { type: "example", text: "for (let i = 1; i <= 5; i++) { console.log(i); } → prints 1 through 5." },
        { type: "keyPoints", items: ["for = counted repeats.", "while = repeats while true.", "Avoid infinite loops.", "Loops save typing and bugs."] },
        code({
          language: "javascript",
          instructions: "Run the loop. Change the number 5 to 10 and Run again.",
          starter: 'for (let i = 1; i <= 5; i++) {\n  console.log("Count: " + i);\n}',
          challenge: "Make the loop print up to 10.",
          expected: "Count: 10",
        }),
      ],
      questions: [
        { q: "Loops let you…", options: ["repeat code efficiently", "delete files", "draw maps", "stop the computer"], answer: "repeat code efficiently", explain: "No copy-paste." },
        { q: "A for loop is best when you know…", options: ["how many times to repeat", "nothing", "the weather", "history dates"], answer: "how many times to repeat", explain: "Counted repeats." },
        { q: "An infinite loop…", options: ["never stops — usually a bug", "is always desired", "only runs once", "prints maps"], answer: "never stops — usually a bug", explain: "Condition never false." },
        { q: "Game animations use loops to…", options: ["update every frame", "cook food", "send email", "write essays"], answer: "update every frame", explain: "Repeat each frame." },
        { q: "i++ means…", options: ["add 1 to i", "subtract 1", "multiply i", "stop the loop"], answer: "add 1 to i", explain: "Increment counter." },
      ],
    },
    {
      topic: "Loops & Functions",
      ...
      minutes: 12,
      points: 80,
      summary: "Functions package code under a name so you can call it whenever you need — with optional inputs and outputs.",
      blocks: [
        { type: "heading", text: "Name It, Reuse It" },
        { type: "text", text: "function greet(name) { return 'Hello, ' + name; } defines a reusable block. Call it: greet('Alex'). Functions can take parameters (inputs) and return a value (output).\n\nOrganising code into functions makes programs easier to read, test, and fix." },
        { type: "example", text: "function double(n) { return n * 2; } double(7) → 14." },
        { type: "keyPoints", items: ["function name() { ... }", "Parameters = inputs.", "return sends a value back.", "Define once, call many times."] },
        code({
          language: "javascript",
          instructions: "Run the code. Add a call greet('YourName') and Run again.",
          starter: 'function greet(name) {\n  return "Hello, " + name + "!";\n}\nconsole.log(greet("World"));',
          challenge: "Add: console.log(greet(\"Coder\"));",
          expected: "Hello, Coder!",
        }),
      ],
      questions: [
        { q: "Functions help you…", options: ["reuse organised code", "avoid all variables", "delete loops", "stop thinking"], answer: "reuse organised code", explain: "Modular code." },
        { q: "Parameters are…", options: ["inputs to a function", "outputs only", "bugs", "colours"], answer: "inputs to a function", explain: "Passed in when called." },
        { q: "return sends…", options: ["a value back to the caller", "nothing ever", "only errors", "emails"], answer: "a value back to the caller", explain: "Function output." },
        { q: "double(7) calls a function with…", options: ["argument 7", "no name", "infinite loop", "a map"], answer: "argument 7", explain: "7 is the argument." },
        { q: "Good function names should be…", options: ["clear about what they do", "random letters", "always one letter", "secret"], answer: "clear about what they do", explain: "Readable code." },
      ],
    },
    {
      topic: "Loops & Functions",
      title: "Arrays & Lists in Code",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "An array stores many values in order — loop through them to process scores, names, or inventory items.",
      blocks: [
        { type: "heading", text: "Lists of Data" },
        { type: "text", text: "let scores = [10, 25, 30]; creates an array. Access items with scores[0] (first item — counting starts at 0). Loop: for (let i = 0; i < scores.length; i++) { ... }\n\nArrays model game inventories, quiz answers, and leaderboard entries." },
        { type: "example", text: "let fruits = ['apple', 'banana']; fruits[1] → 'banana'." },
        { type: "keyPoints", items: ["Arrays use [ ] brackets.", "Index starts at 0.", ".length = item count.", "Loop to process all items."] },
        code({
          language: "javascript",
          instructions: "Run to sum the scores. Add another number to the array and Run again.",
          starter: 'let scores = [10, 20, 30];\nlet total = 0;\nfor (let i = 0; i < scores.length; i++) {\n  total = total + scores[i];\n}\nconsole.log("Total: " + total);',
          expected: "Total: 60",
        }),
      ],
      questions: [
        { q: "First item in an array is index…", options: ["0", "1", "10", "-1"], answer: "0", explain: "Zero-based counting." },
        { q: "scores.length tells you…", options: ["how many items", "the sum", "the colour", "the weather"], answer: "how many items", explain: "Array size." },
        { q: "Arrays are useful for…", options: ["lists of scores or names", "only one number", "maps only", "cooking only"], answer: "lists of scores or names", explain: "Ordered collections." },
        { q: "[10, 20, 30][1] equals…", options: ["20", "10", "30", "0"], answer: "20", explain: "Second item." },
        { q: "Looping an array lets you…", options: ["process every item", "delete the computer", "skip all data", "draw maps only"], answer: "process every item", explain: "Batch processing." },
      ],
    },
    {
      topic: "Loops & Functions",
      title: "Debugging: Finding Fixes",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Bugs are mistakes in code. Read error messages, print debug values, and test small pieces to find fixes.",
      blocks: [
        { type: "heading", text: "Everyone Gets Bugs" },
        { type: "text", text: "A bug is code that does not work as intended. Strategies: read the error message (line number helps!), use console.log to see variable values, comment out sections to isolate the problem, and fix one thing at a time.\n\nSyntax errors stop code running; logic errors run but give wrong results — both are fixable with patience." },
        { type: "example", text: "Expected 60 but got NaN? console.log(total) each loop step — maybe you added a string instead of a number." },
        { type: "keyPoints", items: ["Read error messages carefully.", "console.log = debug eyes.", "Fix one bug at a time.", "Test after each fix."] },
        { type: "interactive", variant: "reveal", data: [
          { key: "question", value: "First step when code fails?" },
          { key: "option_0", value: "Read the error message and line number" },
          { key: "option_1", value: "Delete the whole program" },
          { key: "option_2", value: "Ignore it" },
          { key: "option_3", value: "Change nothing and hope" },
          { key: "answer", value: "Read the error message and line number" },
          { key: "explanation", value: "Errors often tell you exactly where to look." },
        ]},
      ],
      questions: [
        { q: "A syntax error means…", options: ["code grammar is wrong", "logic is perfect", "game won", "no bug"], answer: "code grammar is wrong", explain: "Won't run." },
        { q: "console.log helps you…", options: ["see values while debugging", "delete bugs magically", "skip testing", "avoid loops"], answer: "see values while debugging", explain: "Debug output." },
        { q: "Logic errors…", options: ["run but give wrong results", "never run", "fix themselves", "only happen in maps"], answer: "run but give wrong results", explain: "Harder to spot." },
        { q: "Good debugging fixes…", options: ["one thing at a time", "everything randomly", "nothing ever", "only on paper"], answer: "one thing at a time", explain: "Isolate the cause." },
        { q: "Error line numbers point you to…", options: ["where to look first", "lunch menu", "history dates", "map north"], answer: "where to look first", explain: "Starting point." },
      ],
    },
    {
      topic: "Loops & Functions",
      title: "Activity: Loops & Times Tables",
      difficulty: "intermediate",
      minutes: 12,
      points: 100,
      summary: "Use a loop to print the 7 times table — practice loops with real output.",
      kind: "activity",
      blocks: [
        { type: "heading", text: "Loop Lab: Times Table" },
        { type: "text", text: "Complete the loop so it prints 7 × 1 through 7 × 12." },
        code({
          language: "javascript",
          instructions: "Run the starter. Fix or extend the loop to print all lines from 7 x 1 = 7 to 7 x 12 = 84.",
          starter: 'for (let i = 1; i <= 12; i++) {\n  console.log("7 x " + i + " = " + (7 * i));\n}',
          expected: "7 x 12 = 84",
        }),
      ],
      questions: [
        { q: "7 × 8 = ?", options: ["56", "48", "64", "72"], answer: "56", explain: "Times table." },
        { q: "Loops reduce…", options: ["repeated copy-paste code", "all thinking", "variables", "functions"], answer: "repeated copy-paste code", explain: "Efficiency." },
        { q: "7 × 12 = ?", options: ["84", "72", "96", "60"], answer: "84", explain: "Last line of table." },
        { q: "i <= 12 means i goes up to…", options: ["12", "11", "13", "0"], answer: "12", explain: "Inclusive limit." },
        { q: "Multiplication in code uses…", options: ["*", "+", "#", "@"], answer: "*", explain: "7 * i." },
      ],
    },
    {
      topic: "Loops & Functions",
      title: "Activity: Build a Mini Quiz Function",
      difficulty: "advanced",
      minutes: 14,
      points: 110,
      summary: "Write a function that checks an answer and prints whether the player is correct.",
      kind: "activity",
      blocks: [
        { type: "heading", text: "Function Lab: Quiz Checker" },
        { type: "text", text: "Functions can encode game rules. Write checkAnswer(question, guess, correct) that prints 'Correct!' or 'Try again'." },
        code({
          language: "javascript",
          instructions: "Run the code. Change the guess variable and Run again to test both messages.",
          starter: 'function checkAnswer(guess, correct) {\n  if (guess === correct) {\n    console.log("Correct!");\n  } else {\n    console.log("Try again");\n  }\n}\ncheckAnswer(4, 4);\ncheckAnswer(3, 4);',
          expected: "Try again",
        }),
      ],
      questions: [
        { q: "=== checks…", options: ["strict equality", "only addition", "map scale", "weather"], answer: "strict equality", explain: "Same value and type." },
        { q: "Encapsulating rules in a function…", options: ["keeps code tidy", "prevents all bugs forever", "removes loops", "deletes arrays"], answer: "keeps code tidy", explain: "Reusable logic." },
        { q: "guess === correct means…", options: ["guess equals correct", "guess is bigger", "always false", "syntax error"], answer: "guess equals correct", explain: "Comparison." },
        { q: "Functions can be called…", options: ["many times with different arguments", "only once ever", "never", "only on paper"], answer: "many times with different arguments", explain: "Reusability." },
        { q: "A quiz checker is an example of…", options: ["game logic in a function", "geography map", "history source", "cooking recipe"], answer: "game logic in a function", explain: "Rules as code." },
      ],
    },
    ...
    // ===================== TEXT & DATA (3) =====================
    {
      ...
      minutes: 14,
      points: 90,
      summary: "A string is text in quotes; you can join (+), measure (.length) and change text in code.",
      blocks: [
        { type: "heading", text: "Words in Code" },
        { type: "text", text: "A STRING is a piece of text, written inside quotes: \"Hello\" or 'cat'. You can JOIN strings with + (\"Hello \" + \"there\"), COUNT letters with .length (\"cat\".length is 3), and turn text UPPERCASE or lowercase with methods.\n\nStrings hold names, messages, anything wordy. Numbers don't use quotes — 42 is a number, \"42\" is text. Mixing them up is a classic bug." },
        { type: "example", text: "let name = \"Hudson\"; console.log(\"Hi \" + name); → prints 'Hi Hudson'. name.length → 6." },
        { type: "keyPoints", items: ["Strings = text in quotes.", "Join with +.", ".length counts characters.", "Numbers don't use quotes."] },
        code({
          language: "javascript",
          starter: `let name = "Hudson";\nlet mood = "great";\nconsole.log("Hello " + name);\nconsole.log(name.length);`,
          instructions: "Run the code. Then change the name and add a line that prints a greeting using mood.",
          challenge: "Make it print: Hello Hudson, you are great!",
          expected: "Hello Hudson, you are great!",
        }),
      ],
      questions: [
        { q: "A piece of text in quotes is a…", options: ["string", "number", "loop", "function"], answer: "string", explain: "Text data." },
        { q: "To join two strings, use…", options: ["+", "−", "×", "/"], answer: "+", explain: "Concatenation." },
        { q: "\"cat\".length is…", options: ["3", "cat", "0", "6"], answer: "3", explain: "Three characters." },
        { q: "Which is a number, not a string?", options: ["42", "\"42\"", "\"hi\"", "\"cat\""], answer: "42", explain: "No quotes = number." },
        { q: "console.log(\"Hi \" + \"there\") prints…", options: ["Hi there", "Hithere", "Hi+there", "nothing"], answer: "Hi there", explain: "Note the space inside the quotes." },
      ],
    },
    {
      topic: "Text & Data",
      ...
      minutes: 14,
      points: 90,
      summary: "An array is an ordered list; access items by index (starting at 0) and use .length.",
      blocks: [
        { type: "heading", text: "Lists of Things" },
        { type: "text", text: "An ARRAY is a list of values in one variable: let colours = [\"red\", \"green\", \"blue\"]. You read items by their INDEX (position), but indexes start at 0 — so colours[0] is 'red', colours[1] is 'green'. The .length tells you how many items.\n\nArrays are perfect for collections: a list of scores, of players, of quiz questions. You can loop over an array to do something to every item." },
        { type: "example", text: "let scores = [10, 20, 30]; scores[0] is 10 (first). scores.length is 3. To get the LAST item: scores[scores.length − 1] = 30." },
        { type: "keyPoints", items: ["Array = ordered list.", "Index starts at 0.", "arr[0] = first item.", ".length = how many."] },
        code({
          language: "javascript",
          starter: `let fruits = ["apple", "banana", "grape"];\nconsole.log(fruits[0]);\nconsole.log(fruits.length);`,
          instructions: "Run it. Then print the LAST fruit using fruits[fruits.length - 1].",
          challenge: "Print the last fruit: grape",
          expected: "grape",
        }),
      ],
      questions: [
        { q: "An array is…", options: ["an ordered list", "a single number", "a kind of loop", "a string"], answer: "an ordered list", explain: "A collection." },
        { q: "Indexes start at…", options: ["0", "1", "−1", "10"], answer: "0", explain: "First item = index 0." },
        { q: "In [10, 20, 30], the item at index 1 is…", options: ["20", "10", "30", "1"], answer: "20", explain: "Second item." },
        { q: "[5, 6, 7].length is…", options: ["3", "7", "0", "5"], answer: "3", explain: "Three items." },
        { q: "To get the LAST item of arr, use…", options: ["arr[arr.length - 1]", "arr[1]", "arr.last", "arr[0]"], answer: "arr[arr.length - 1]", explain: "Last index." },
      ],
    },
    {
      topic: "Text & Data",
      ...
      minutes: 14,
      points: 90,
      summary: "if/else lets code make choices: if a condition is true, do one thing; else do another.",
      blocks: [
        { type: "heading", text: "Branching Code" },
        { type: "text", text: "An if/else statement lets your code choose. If a CONDITION is true, the first block runs; otherwise (else) the other block runs. Conditions use comparisons like > (more than), < (less than), === (equal to).\n\nExample: if (score >= 10) { print 'Win' } else { print 'Try again' }. This is how a quiz decides pass/fail, or a game decides win/lose." },
        { type: "example", text: "let age = 11; if (age >= 10) { console.log('Big enough'); } else { console.log('Too young'); } → prints 'Big enough'." },
        { type: "keyPoints", items: ["if = if this is true.", "else = otherwise.", "Comparisons: >, <, ===, >=.", "Code branches on conditions."] },
        code({
          language: "javascript",
          starter: `let score = 7;\nif (score >= 8) {\n  console.log("Pass");\n} else {\n  console.log("Try again");\n}`,
          instructions: "Run it (score 7 prints 'Try again'). Change score to 9 and run again.",
          challenge: "Set score so it prints: Pass",
          expected: "Pass",
        }),
      ],
      questions: [
        { q: "if/else lets code…", options: ["make choices", "play music", "draw only", "stop forever"], answer: "make choices", explain: "Branching." },
        { q: ">= means…", options: ["more than or equal to", "equal only", "less than", "not equal"], answer: "more than or equal to", explain: "A comparison." },
        { q: "If (5 > 3) is…", options: ["true", "false", "a string", "an error"], answer: "true", explain: "5 is more than 3." },
        { q: "The 'else' block runs when…", options: ["the condition is false", "always", "never", "the code loops"], answer: "the condition is false", explain: "Otherwise." },
        { q: "score = 7 with 'if (score >= 8)' prints…", options: ["Try again (else)", "Pass", "nothing", "an error"], answer: "Try again (else)", explain: "7 < 8." },
      ],
    },
  ],
};
...
export const geography: SubjectCurriculum = {
  ...
  topics: [
    ...
    { name: "Africa", description: "Countries, the Sahara, savanna and the Nile.", difficulty: "intermediate" },
    { name: "Australia & Oceania", description: "The Outback, Reef and Pacific islands.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== MAPS & SKILLS (4) =====================
    {
    ...
    // ===================== AFRICA (4) =====================
    {
      ...
      minutes: 12,
      points: 80,
      summary: "Africa has 54 countries — the most of any continent — including Egypt, Nigeria, Kenya and South Africa.",
      blocks: [
        { type: "heading", text: "A Vast Continent" },
        { type: "text", text: "Africa is the second-largest continent and has 54 countries — more than any other. They range from EGYPT in the north (famous for pyramids) to NIGERIA in the west (Africa's most populous country), KENYA in the east (safari land) and SOUTH AFRICA at the southern tip.\n\nAfrica was home to powerful ancient kingdoms (like Mali and Egypt) and suffered badly from the transatlantic slave trade and colonisation. Today it has hundreds of languages and fast-growing cities, plus huge wildlife reserves." },
        { type: "example", text: "Africa is so big it could fit the USA, China, India and most of Europe inside it — with room to spare." },
        { type: "keyPoints", items: ["54 countries (most of any continent).", "Egypt (north) → South Africa (south).", "Hundreds of languages.", "Once colonised; now independent."] },
        match(["Egypt", "Pyramids + the Nile"], ["Nigeria", "Most populous"], ["Kenya", "Safari + savanna"], ["South Africa", "Southern tip"]),
      ],
      questions: [
        { q: "Africa has how many countries?", options: ["54", "12", "5", "100"], answer: "54", explain: "Most of any continent." },
        { q: "Which African country is famous for pyramids?", options: ["Egypt", "Kenya", "Nigeria", "Chile"], answer: "Egypt", explain: "Ancient Egyptians." },
        { q: "Africa's most populous country is…", options: ["Nigeria", "Egypt", "South Africa", "Algeria"], answer: "Nigeria", explain: "Over 200 million people." },
        { q: "Which is at Africa's southern tip?", options: ["South Africa", "Egypt", "Kenya", "Morocco"], answer: "South Africa", explain: "Far south." },
        { q: "Africa could fit which inside it?", options: ["USA + China + India + Europe", "only Britain", "just one town", "nothing"], answer: "USA + China + India + Europe", explain: "It's huge." },
      ],
    },
    {
      topic: "Africa",
      ...
      minutes: 12,
      points: 80,
      summary: "The Sahara is the world's largest hot desert, covering North Africa with sand, rock and little rain.",
      blocks: [
        { type: "heading", text: "A Sea of Sand" },
        { type: "text", text: "The SAHARA is the largest HOT desert in the world, stretching across the whole top of Africa. It's scorching by day, freezing at night, and gets almost no rain. Despite the heat, millions live there — near oases (water springs) where date palms and crops grow.\n\nFor centuries, camel caravans crossed the Sahara trading salt, gold and ivory between Africa's north and south. The desert is mostly bare rock and gravel, with huge sand dunes in places." },
        { type: "example", text: "An oasis is a spot where underground water reaches the surface — a green island of palms in the desert where people can settle and farm." },
        { type: "keyPoints", items: ["Largest HOT desert in the world.", "Covers North Africa.", "Hot by day, freezing at night.", "Oases = desert water springs."] },
      ],
      questions: [
        { q: "The Sahara is the largest ___ desert.", options: ["hot", "cold", "rainy", "snowy"], answer: "hot", explain: "Antarctica is the largest cold desert." },
        { q: "The Sahara covers…", options: ["North Africa", "South America", "Australia", "Asia"], answer: "North Africa", explain: "Across the top." },
        { q: "Sahara temperatures are…", options: ["hot by day, freezing at night", "always mild", "always snowy", "always wet"], answer: "hot by day, freezing at night", explain: "Little cloud/rain." },
        { q: "An oasis is…", options: ["a desert water spring", "a type of camel", "a sand dune", "a city"], answer: "a desert water spring", explain: "Green palm islands." },
        { q: "Camel caravans crossed the Sahara trading…", options: ["salt, gold and ivory", "potatoes", "coffee only", "cars"], answer: "salt, gold and ivory", explain: "For centuries." },
      ],
    },
    {
      topic: "Africa",
      title: "African Savanna & Wildlife",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "The savanna is grassland with scattered trees, home to lions, elephants, giraffes and zebras.",
      blocks: [
        { type: "heading", text: "The Great Plains" },
        { type: "text", text: "The SAVANNA is tropical grassland with scattered trees, covering huge areas of central and southern Africa. It's home to the world's most famous wildlife: lions, elephants, giraffes, zebras, rhinos and vast herds of wildebeest.\n\nEach year, over a million wildebeest take part in the GREAT MIGRATION across the Serengeti, chasing rains and fresh grass — one of nature's great spectacles. Countries like Kenya and Tanzania protect these animals in huge national parks." },
        { type: "example", text: "The Great Migration: ~1.5 million wildebeest plus zebras and gazelles thunder across the Serengeti every year, crossing crocodile-infested rivers." },
        { type: "keyPoints", items: ["Savanna = grassland + scattered trees.", "Home to lions, elephants, giraffes.", "Great Migration of wildebeest.", "Protected in national parks."] },
      ],
      questions: [
        { q: "The savanna is…", options: ["grassland with scattered trees", "thick rainforest", "sand desert", "ice"], answer: "grassland with scattered trees", explain: "Tropical grassland." },
        { q: "Which animals live on the African savanna?", options: ["Lions + elephants", "Polar bears", "Penguins", "Kangaroos"], answer: "Lions + elephants", explain: "Famous wildlife." },
        { q: "The Great Migration is…", options: ["wildebeest chasing rains/grass", "a war", "a trade route", "a festival"], answer: "wildebeest chasing rains/grass", explain: "Across the Serengeti." },
        { q: "Which countries protect savanna wildlife?", options: ["Kenya + Tanzania", "France + Spain", "Japan", "Canada"], answer: "Kenya + Tanzania", explain: "In national parks." },
        { q: "A savanna has mostly…", options: ["grass + a few trees", "dense trees only", "no plants", "ice"], answer: "grass + a few trees", explain: "Not a forest or desert." },
      ],
    },
    {
      topic: "Africa",
      title: "The Nile & Victoria Falls",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Africa holds the world's longest river (the Nile) and the huge Victoria Falls — 'the smoke that thunders'.",
      blocks: [
        { type: "heading", text: "Water Wonders" },
        { type: "text", text: "Africa has two amazing water features. The NILE, the longest river in the world, flows north for ~6,650 km through 11 countries to the Mediterranean — it gave life to Ancient Egypt. VICTORIA FALLS, on the border of Zambia and Zimbabwe, is one of the biggest waterfalls on Earth, so loud and misty that locals call it 'Mosi-oa-Tunya' — 'the smoke that thunders'.\n\nBoth draw millions of visitors and are vital for farming, power and wildlife." },
        { type: "example", text: "Victoria Falls is about twice as high as Niagara Falls and spans the whole Zambezi River — its spray can be seen from miles away." },
        { type: "keyPoints", items: ["Nile = longest river (~6,650 km).", "Flows north to the Mediterranean.", "Victoria Falls = huge waterfall.", "'The smoke that thunders'."] },
      ],
      questions: [
        { q: "The longest river in the world is the…", options: ["Nile", "Amazon", "Thames", "Mississippi"], answer: "Nile", explain: "~6,650 km." },
        { q: "The Nile flows…", options: ["north", "south", "in a circle", "up a mountain"], answer: "north", explain: "To the Mediterranean." },
        { q: "Victoria Falls is on the border of…", options: ["Zambia + Zimbabwe", "Egypt + Libya", "Kenya + Uganda", "USA + Canada"], answer: "Zambia + Zimbabwe", explain: "On the Zambezi." },
        { q: "'Mosi-oa-Tunya' means…", options: ["'the smoke that thunders'", "'big river'", "'cold water'", "'no water'"], answer: "'the smoke that thunders'", explain: "Local name." },
        { q: "Victoria Falls is about ___ as high as Niagara.", options: ["twice", "half", "ten times shorter", "the same"], answer: "twice", explain: "Much higher." },
      ],
    },
    ...
    // ===================== AUSTRALIA & OCEANIA (4) =====================
    {
      ...
      title: "Australia & the Outback",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Australia is both a country and a continent; its dry centre, the Outback, is hot and remote.",
      blocks: [
        { type: "heading", text: "A Country and a Continent" },
        { type: "text", text: "AUSTRALIA is unusual — it's both a country and a continent. Most Australians live on the cooler, wetter COASTS, while the huge dry interior — the OUTBACK — is hot, red and sparsely populated. The Outback has vast cattle and sheep stations bigger than some countries.\n\nAustralia's first people, Aboriginal Australians, have lived there for over 50,000 years — the oldest continuous culture on Earth. They deeply understand the land, water and wildlife." },
        { type: "example", text: "Uluru (Ayers Rock) is a giant red sandstone rock in the Outback, sacred to Aboriginal Australians and visible for miles." },
        { type: "keyPoints", items: ["Australia = country + continent.", "Most live on the coasts.", "Outback = hot, dry, remote centre.", "Aboriginal culture 50,000+ years old."] },
      ],
      questions: [
        { q: "Australia is…", options: ["a country and a continent", "only a country", "only a continent", "an island only"], answer: "a country and a continent", explain: "Unique." },
        { q: "Australia's dry interior is called the…", options: ["Outback", "Sahara", "Savanna", "Tundra"], answer: "Outback", explain: "Hot + remote." },
        { q: "Most Australians live…", options: ["on the coasts", "in the Outback", "on Uluru", "in the desert"], answer: "on the coasts", explain: "Cooler + wetter." },
        { q: "Aboriginal Australians have lived there for…", options: ["50,000+ years", "100 years", "1,000 years", "50 years"], answer: "50,000+ years", explain: "Oldest continuous culture." },
        { q: "Uluru is…", options: ["a giant red rock", "a city", "a river", "a type of kangaroo"], answer: "a giant red rock", explain: "Sacred sandstone." },
      ],
    },
    {
      topic: "Australia & Oceania",
      ...
      minutes: 12,
      points: 80,
      summary: "The Great Barrier Reef is the world's largest coral reef, home to thousands of sea species.",
      blocks: [
        { type: "heading", text: "A Living Wonder" },
        { type: "text", text: "The GREAT BARRIER REEF, off Australia's north-east coast, is the largest coral reef system on Earth — so big it can be seen from space. It's built by tiny animals called CORAL POLYPS, whose skeletons form the reef over thousands of years. It's home to thousands of species: colourful fish, turtles, sharks, whales and more.\n\nBut coral is fragile. Warmer seas and pollution cause CORAL BLEACHING, where the coral turns white and can die — a serious threat to this natural wonder." },
        { type: "example", text: "Coral looks like rock or plant, but each piece is a colony of tiny animals — coral polyps — that build the reef together." },
        { type: "keyPoints", items: ["Largest coral reef (seen from space).", "Built by tiny coral polyps.", "Thousands of sea species.", "Bleaching (warming) threatens it."] },
      ],
      questions: [
        { q: "The Great Barrier Reef is…", options: ["the largest coral reef", "a desert", "a mountain range", "a river"], answer: "the largest coral reef", explain: "Off Australia." },
        { q: "Coral reefs are built by…", options: ["tiny coral polyps (animals)", "plants only", "fish", "rocks only"], answer: "tiny coral polyps (animals)", explain: "Tiny animals." },
        { q: "The Reef is home to…", options: ["thousands of sea species", "no life", "only sharks", "polar bears"], answer: "thousands of sea species", explain: "Fish, turtles, whales." },
        { q: "Coral bleaching is caused by…", options: ["warmer seas + pollution", "too many fish", "cold", "rain"], answer: "warmer seas + pollution", explain: "Coral turns white + can die." },
        { q: "The Great Barrier Reef can be seen from…", options: ["space", "only the Moon", "only nearby", "nowhere"], answer: "space", explain: "It's enormous." },
      ],
    },
    {
      topic: "Australia & Oceania",
      title: "Pacific Islands & Oceania",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Oceania has thousands of Pacific islands — from New Zealand to Fiji — many volcanic or low coral atolls.",
      blocks: [
        { type: "heading", text: "A Sea of Islands" },
        { type: "text", text: "OCEANIA is the region of the Pacific Ocean containing thousands of islands. The largest countries are AUSTRALIA and NEW ZEALAND. Beyond them are countless islands grouped as MELANESIA, MICRONESIA and POLYNESIA — including Fiji, Samoa and Tonga.\n\nSome islands are VOLCANIC (mountainous, with fertile soil) and others are low coral ATOLLS (ring-shaped reefs). Polynesian sailors crossed huge stretches of ocean in canoes, navigating by stars and waves, long before Europeans." },
        { type: "example", text: "Polynesian navigators sailed thousands of kilometres across the Pacific in double-hulled canoes, reading stars, currents and birds — incredible feats of wayfinding." },
        { type: "keyPoints", items: ["Oceania = thousands of Pacific islands.", "Largest: Australia + New Zealand.", "Volcanic islands + coral atolls.", "Polynesians were master navigators."] },
      ],
      questions: [
        { q: "Oceania contains…", options: ["thousands of Pacific islands", "one big island", "no islands", "only deserts"], answer: "thousands of Pacific islands", explain: "Across the Pacific." },
        { q: "The two largest countries in Oceania are…", options: ["Australia + New Zealand", "Fiji + Samoa", "Japan + China", "USA + Canada"], answer: "Australia + New Zealand", explain: "Biggest landmasses." },
        { q: "A low ring-shaped coral island is an…", options: ["atoll", "atoll (coral ring)", "volcano", "mountain"], answer: "atoll (coral ring)", explain: "Built by coral." },
        { q: "Polynesian sailors navigated using…", options: ["stars + currents + birds", "GPS", "maps only", "roads"], answer: "stars + currents + birds", explain: "Incredible wayfinding." },
        { q: "Volcanic islands tend to be…", options: ["mountainous + fertile", "flat + sandy", "underwater", "frozen"], answer: "mountainous + fertile", explain: "Built from volcanoes." },
      ],
    },
    {
      topic: "Australia & Oceania",
      title: "Unique Australian Animals",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Australia's animals are unique — marsupials (kangaroos, koalas) and the egg-laying platypus.",
      blocks: [
        { type: "heading", text: "Found Nowhere Else" },
        { type: "text", text: "Because Australia has been cut off from other continents for millions of years, its animals evolved in their own special ways. Many are MARSUPIALS — mammals that carry their babies in a pouch, like KANGAROOS and KOALAS. The PLATYPUS is one of only two mammals that LAY EGGS.\n\nOther unique animals include the emu, the laughing kookaburra, and dangerous snakes and spiders. Most of these animals live nowhere else on Earth." },
        { type: "example", text: "A baby kangaroo (joey) is born tiny and crawls into its mother's pouch, where it grows for months — a classic marsupial." },
        { type: "keyPoints", items: ["Australian animals are unique.", "Marsupials carry babies in a pouch.", "Kangaroo, koala = marsupials.", "Platypus lays eggs (rare mammal)."] },
      ],
      questions: [
        { q: "A marsupial is a mammal that…", options: ["carries babies in a pouch", "lays eggs", "can fly", "lives in the sea"], answer: "carries babies in a pouch", explain: "Like kangaroos." },
        { q: "Which is a marsupial?", options: ["Kangaroo", "Cat", "Cow", "Whale"], answer: "Kangaroo", explain: "Pouch-bearing." },
        { q: "The platypus is unusual because it…", options: ["lays eggs", "has a pouch", "can fly", "is a fish"], answer: "lays eggs", explain: "Rare egg-laying mammal." },
        { q: "Why are Australian animals so unique?", options: ["Australia was cut off for millions of years", "they were made in a lab", "the cold", "they were imported"], answer: "Australia was cut off for millions of years", explain: "Evolved separately." },
        { q: "A baby kangaroo is called a…", options: ["joey", "cub", "calf", "pup"], answer: "joey", explain: "Lives in the pouch." },
      ],
    },
  ],
};

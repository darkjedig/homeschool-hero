...
import { arena, mcq, ord, match } from "./types";
...
export const maths: SubjectCurriculum = {
  ...
  topics: [
    ...
    { name: "Written Methods", description: "Column addition/subtraction, long multiplication, short division.", difficulty: "intermediate" },
    { name: "3D Shapes & Volume", description: "Solids, nets, faces/edges/vertices and volume.", difficulty: "intermediate" },
    { name: "Coordinates & Graphs", description: "Plotting points and reading line graphs.", difficulty: "intermediate" },
    { name: "Probability", description: "Likely, unlikely, certain, impossible and simple chance.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== FRACTIONS (6) =====================
    {
    ...
    // ===================== WRITTEN METHODS (4) =====================
    {
      ...
      title: "Column Addition & Subtraction",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Stack numbers in columns by place value; add or subtract right-to-left, carrying/exchanging as needed.",
      blocks: [
        { type: "heading", text: "Stack and Solve" },
        { type: "text", text: "Written methods let you add or subtract big numbers without losing track of place value. Stack the numbers in columns — ones under ones, tens under tens — and work RIGHT to LEFT.\n\nIn addition, if a column adds to 10 or more you CARRY to the next column. In subtraction, if the top digit is too small you EXCHANGE (borrow) from the next column. Always line up the digits carefully — a crooked column means a wrong answer." },
        { type: "example", text: "358 + 274: 8+4=12 (write 2, carry 1), 5+7+1=13 (write 3, carry 1), 3+2+1=6 → 632." },
        { type: "keyPoints", items: ["Stack by place value (ones over ones).", "Work right to left.", "Addition: carry when ≥10.", "Subtraction: exchange (borrow)."] },
        mcq("Add: 358 + 274 = ?", ["632", "522", "712", "612"], "632", "Stack and carry."),
      ],
      questions: [
        { q: "245 + 312 = ?", options: ["557", "537", "547", "558"], answer: "557", explain: "Column addition." },
        { q: "586 − 243 = ?", options: ["343", "353", "443", "333"], answer: "343", explain: "Column subtraction." },
        { q: "In addition, when a column is 10+, you…", options: ["carry to the next column", "ignore it", "subtract it", "start over"], answer: "carry to the next column", explain: "Carry the 1." },
        { q: "In subtraction, if the top is too small you…", options: ["exchange (borrow)", "skip it", "add 10", "give up"], answer: "exchange (borrow)", explain: "Borrow from the next column." },
        { q: "Why line up columns carefully?", options: ["To keep place value correct", "To look neat", "No reason", "To use less paper"], answer: "To keep place value correct", explain: "Ones over ones, etc." },
      ],
    },
    {
      topic: "Written Methods",
      ...
      minutes: 14,
      points: 90,
      summary: "Multiply a 2-digit number by another: multiply by the ones, then the tens (shifted), then add.",
      blocks: [
        { type: "heading", text: "Big Multiplications" },
        { type: "text", text: "Long multiplication breaks a big multiply into smaller steps. To do 34 × 26: first multiply 34 by the ones (6) → 204. Then multiply 34 by the tens (20) → 680, written shifted one place left (so it's really 680). Add 204 + 680 = 884.\n\nThe shifting is the key: the tens row is written one place to the left because you're really multiplying by 20, not 2." },
        { type: "example", text: "34 × 26: 34×6 = 204, 34×20 = 680 (shifted), 204+680 = 884. Check: 34×26 = 884." },
        { type: "keyPoints", items: ["Multiply by ones first.", "Then by tens (shift left).", "Add the rows.", "Shifting handles the zero."] },
        mcq("23 × 12 = ?", ["276", "246", "256", "266"], "276", "23×12: 23×2=46, 23×10=230 → 276."),
      ],
      questions: [
        { q: "45 × 11 = ?", options: ["495", "455", "505", "445"], answer: "495", explain: "45×1 + 45×10." },
        { q: "In long multiplication, the tens row is…", options: ["shifted one place left", "written the same", "ignored", "doubled"], answer: "shifted one place left", explain: "It's really ×10/×20 etc." },
        { q: "23 × 12 = ?", options: ["276", "246", "256", "266"], answer: "276", explain: "46 + 230." },
        { q: "Step one of 34 × 26 is…", options: ["34 × 6", "34 × 20", "6 × 20", "34 + 26"], answer: "34 × 6", explain: "Multiply by ones first." },
        { q: "After the two rows you…", options: ["add them", "subtract them", "multiply again", "ignore one"], answer: "add them", explain: "Sum the partial products." },
      ],
    },
    {
      topic: "Written Methods",
      title: "Short Division (Bus-Stop)",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "Short division divides a big number by a single digit, carrying remainders left as you go.",
      blocks: [
        { type: "heading", text: "The Bus-Stop Method" },
        { type: "text", text: "Short division (the 'bus-stop' method) divides a large number by a single-digit divisor. You work LEFT to right: divide each digit, and any remainder is carried over to the next digit (as a small ten).\n\nExample 96 ÷ 4: 9 ÷ 4 = 2 remainder 1. Write 2 on top, carry the 1 to make the 6 into 16. 16 ÷ 4 = 4. Answer: 24." },
        { type: "example", text: "84 ÷ 3: 8 ÷ 3 = 2 r2 (carry 2 → 24), 24 ÷ 3 = 8. Answer 28. Check: 28 × 3 = 84." },
        { type: "keyPoints", items: ["Work left to right.", "Divide each digit.", "Carry remainders to the next.", "Check by multiplying back."] },
        mcq("96 ÷ 4 = ?", ["24", "22", "26", "28"], "24", "9÷4=2r1 → 16÷4=4."),
      ],
      questions: [
        { q: "84 ÷ 3 = ?", options: ["28", "27", "29", "26"], answer: "28", explain: "8÷3=2r2 → 24÷3=8." },
        { q: "75 ÷ 5 = ?", options: ["15", "14", "25", "11"], answer: "15", explain: "7÷5=1r2 → 25÷5=5." },
        { q: "In short division, remainders are…", options: ["carried to the next digit", "thrown away", "added at the end", "ignored"], answer: "carried to the next digit", explain: "As a carried ten." },
        { q: "Short division works left to…", options: ["right", "down", "in a circle", "right to left"], answer: "right", explain: "Start with the biggest place." },
        { q: "Check 96 ÷ 4 = 24 by…", options: ["24 × 4 = 96", "24 + 4", "96 − 24", "24 ÷ 4"], answer: "24 × 4 = 96", explain: "Multiply back." },
      ],
    },
    {
      topic: "Written Methods",
      ...
      minutes: 12,
      points: 80,
      summary: "Mental tricks — rounding, bonds, doubling/halving — let you solve maths in your head.",
      blocks: [
        { type: "heading", text: "Smart Head Maths" },
        { type: "text", text: "Good mental mathematicians don't just 'know' answers — they use tricks. ROUND and adjust: 49 + 28 → 50 + 28 = 78, then −1 → 77. Use NUMBER BONDS: 7 + 3 = 10, so 70 + 30 = 100. DOUBLE and HALVE: 25 × 4 = (25 × 2) × 2 = 50 × 2 = 100.\n\nThese strategies turn scary sums into friendly ones you can do in your head." },
        { type: "example", text: "98 + 47: round 98 to 100, 100 + 47 = 147, then −2 = 145. Much easier than carrying in your head." },
        { type: "keyPoints", items: ["Round then adjust.", "Use number bonds to 10/100.", "Double and halve.", "Pick the friendliest numbers."] },
        arena({ title: "Mental Maths Sprint", mode: "mixed", min: 2, max: 50, count: 12, seconds: 60 }),
      ],
      questions: [
        { q: "49 + 28 mentally: round 49 to 50, then…", options: ["−1 at the end", "+1 at the end", "+10", "×2"], answer: "−1 at the end", explain: "You added 1 too many." },
        { q: "25 × 4 using doubling = ?", options: ["100", "50", "75", "29"], answer: "100", explain: "25×2=50, ×2=100." },
        { q: "7 + 3 = 10 helps with 70 + 30 = ?", options: ["100", "70", "30", "10"], answer: "100", explain: "Number bonds." },
        { q: "98 + 47 (round 98→100) ≈ ?", options: ["145", "147", "135", "155"], answer: "145", explain: "100+47=147, −2." },
        { q: "Mental maths uses…", options: ["strategies, not just memory", "only memory", "a calculator", "nothing"], answer: "strategies, not just memory", explain: "Tricks make it easy." },
      ],
    },
    ...
    // ===================== 3D SHAPES & VOLUME (4) =====================
    {
      ...
      title: "Naming 3D Solids",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "3D solids (cube, cuboid, sphere, cone, pyramid) have faces, edges and vertices.",
      blocks: [
        { type: "heading", text: "Solid Shapes" },
        { type: "text", text: "A 3D (three-dimensional) solid takes up space. Each flat surface is a FACE; where two faces meet is an EDGE; where edges meet at a point is a VERTEX (plural: vertices).\n\nCommon solids: a CUBE has 6 square faces; a CUBOID has 6 rectangular faces (like a brick); a SPHERE is round (a ball); a CYLINDER has two circles and a curved side (a can); a CONE has a circle and a point (an ice-cream cone); a PYRAMID has triangular sides to a point." },
        { type: "example", text: "A cube: 6 faces, 12 edges, 8 vertices. A sphere: 1 curved face, 0 edges, 0 vertices." },
        { type: "keyPoints", items: ["Faces = flat surfaces.", "Edges = where faces meet.", "Vertices = corners.", "Cube: 6/12/8."] },
        match(["Cube", "6 square faces"], ["Sphere", "Round, 0 edges"], ["Cylinder", "2 circles + curved side"], ["Cone", "Circle + point"], ["Pyramid", "Triangles to a point"]),
      ],
      questions: [
        { q: "A flat surface of a 3D shape is a…", options: ["face", "vertex", "edge", "side only"], answer: "face", explain: "Faces are flat." },
        { q: "Where two faces meet is an…", options: ["edge", "face", "vertex", "angle only"], answer: "edge", explain: "Edges meet at vertices." },
        { q: "A cube has how many faces?", options: ["6", "4", "8", "12"], answer: "6", explain: "Six square faces." },
        { q: "A sphere has how many edges?", options: ["0", "1", "6", "12"], answer: "0", explain: "Round, no edges." },
        { q: "A can of beans is a…", options: ["cylinder", "cube", "sphere", "pyramid"], answer: "cylinder", explain: "Two circles + curved side." },
      ],
    },
    {
      topic: "3D Shapes & Volume",
      ...
      minutes: 12,
      points: 80,
      summary: "Count faces (F), edges (E) and vertices (V) to describe any 3D solid precisely.",
      blocks: [
        { type: "heading", text: "Counting the Parts" },
        { type: "text", text: "To describe a solid, count its faces, edges and vertices. A square-based PYRAMID: 1 square face + 4 triangles = 5 faces; 8 edges; 5 vertices. A TRIANGULAR PRISM: 3 rectangles + 2 triangles = 5 faces; 9 edges; 6 vertices.\n\nThere's even a clever pattern (Euler's rule): for many solids, F + V − E = 2. Try it on a cube: 6 + 8 − 12 = 2!" },
        { type: "example", text: "Square-based pyramid: 5 faces, 8 edges, 5 vertices. Check Euler: 5 + 5 − 8 = 2." },
        { type: "keyPoints", items: ["F = faces, E = edges, V = vertices.", "Pyramid (square base): 5/8/5.", "Triangular prism: 5/9/6.", "Euler: F + V − E = 2."] },
        mcq("A cube: 6 + 8 − 12 = ?", ["2", "0", "12", "26"], "2", "Euler's rule."),
      ],
      questions: [
        { q: "A square-based pyramid has how many faces?", options: ["5", "4", "6", "8"], answer: "5", explain: "1 square + 4 triangles." },
        { q: "Vertices on a square-based pyramid?", options: ["5", "4", "8", "6"], answer: "5", explain: "Four base + apex." },
        { q: "F + V − E on a cube (6,8,12) = ?", options: ["2", "0", "12", "26"], answer: "2", explain: "Euler's rule." },
        { q: "A triangular prism has how many edges?", options: ["9", "6", "5", "12"], answer: "9", explain: "3 rectangles + 2 triangles." },
        { q: "How many vertices does a cylinder have?", options: ["0", "2", "6", "8"], answer: "0", explain: "No corners." },
      ],
    },
    {
      topic: "3D Shapes & Volume",
      ...
      minutes: 12,
      points: 80,
      summary: "A net is a flat shape that folds up into a 3D solid; a cube's net is six squares in a cross.",
      blocks: [
        { type: "heading", text: "Fold It Up" },
        { type: "text", text: "A NET is a 2D (flat) shape you can fold to make a 3D solid. A cube's net is six squares joined edge-to-edge (there are 11 different cube nets!). When folded, the squares become the cube's six faces.\n\nVisualising nets helps you see how flat packaging (like a cereal box) becomes a 3D box. Try it: draw a cross of six squares, cut it out, fold — you get a cube." },
        { type: "example", text: "A cereal box is a net of 6 rectangles that folds into a cuboid. An unfolded cube = 6 squares in a cross." },
        { type: "keyPoints", items: ["A net folds into a solid.", "A cube net = 6 squares.", "There are 11 cube nets.", "Packaging uses real nets."] },
        mcq("A cube's net is made of…", ["6 squares", "4 squares", "6 triangles", "1 square"], "6 squares", "One per face."),
      ],
      questions: [
        { q: "A net is…", options: ["a flat shape that folds to a solid", "a 3D shape", "a kind of angle", "a number"], answer: "a flat shape that folds to a solid", explain: "2D → 3D." },
        { q: "A cube's net is made of…", options: ["6 squares", "4 squares", "6 triangles", "8 squares"], answer: "6 squares", explain: "One per face." },
        { q: "How many different cube nets exist?", options: ["11", "1", "6", "100"], answer: "11", explain: "Eleven nets." },
        { q: "A cereal box is a net of a…", options: ["cuboid", "sphere", "cone", "cylinder"], answer: "cuboid", explain: "Six rectangles." },
        { q: "Folding a net makes the…", options: ["faces join at edges", "squares vanish", "shape flat", "vertices disappear"], answer: "faces join at edges", explain: "Edges fold up." },
      ],
    },
    {
      topic: "3D Shapes & Volume",
      ...
      minutes: 14,
      points: 90,
      summary: "Volume is the space inside a 3D shape; for a cuboid it's length × width × height.",
      blocks: [
        { type: "heading", text: "How Much Fits Inside?" },
        { type: "text", text: "Volume measures how much space is inside a 3D shape, counted in cubes (cm³, m³). For a CUBOID (box shape), volume = length × width × height. A box 4 cm × 3 cm × 2 cm holds 4 × 3 × 2 = 24 one-centimetre cubes, so its volume is 24 cm³.\n\nA CUBE is just a special cuboid where all three are equal: a 3 cm cube has volume 3 × 3 × 3 = 27 cm³." },
        { type: "example", text: "A fish tank 50 cm × 20 cm × 10 cm: volume = 50 × 20 × 10 = 10,000 cm³ (10 litres, since 1000 cm³ = 1 litre)." },
        { type: "keyPoints", items: ["Volume = space inside (cm³).", "Cuboid: length × width × height.", "Cube: side × side × side.", "1000 cm³ = 1 litre."] },
        mcq("Volume of a 4 × 3 × 2 cuboid?", ["24 cm³", "9 cm³", "12 cm³", "48 cm³"], "24 cm³", "4×3×2."),
      ],
      questions: [
        { q: "Volume of a 5 × 4 × 2 cuboid?", options: ["40 cm³", "20 cm³", "30 cm³", "11 cm³"], answer: "40 cm³", explain: "5×4×2." },
        { q: "Volume of a 3 cm cube?", options: ["27 cm³", "9 cm³", "12 cm³", "3 cm³"], answer: "27 cm³", explain: "3×3×3." },
        { q: "Volume is measured in…", options: ["cubic units (cm³)", "cm", "grams", "seconds"], answer: "cubic units (cm³)", explain: "Cubes of space." },
        { q: "1000 cm³ = ?", options: ["1 litre", "10 litres", "100 litres", "1 cm"], answer: "1 litre", explain: "Useful conversion." },
        { q: "Cuboid volume formula?", options: ["length × width × height", "l + w + h", "l × w", "l × w ÷ h"], answer: "length × width × height", explain: "Three dimensions." },
      ],
    },

    // ===================== COORDINATES & GRAPHS (3) =====================
    {
      topic: "Coordinates & Graphs",
      title: "Plotting Coordinates",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Coordinates (x, y) pinpoint a spot on a grid; go along the x-axis first, then up the y-axis.",
      blocks: [
        { type: "heading", text: "Along the Corridor, Up the Stairs" },
        { type: "text", text: "A coordinate grid has two axes: the x-axis (horizontal) and the y-axis (vertical). Every point is described by a pair (x, y). The trick to plotting: 'along the corridor, up the stairs' — first go ALONG the x-axis, then UP the y-axis.\n\nThe point (3, 4) means 3 along and 4 up. The centre where axes cross is (0, 0), the origin." },
        { type: "example", text: "Plot (2, 5): go 2 along, then 5 up — mark the spot. Treasure-map grid references work the same way." },
        { type: "keyPoints", items: ["(x, y): x first, then y.", "x = horizontal, y = vertical.", "Origin = (0, 0).", "Plot: along then up."] },
        mcq("Point (4, 2): go…", ["4 along, 2 up", "2 along, 4 up", "4 up, 2 along", "stay at 0"], "4 along, 2 up", "x then y."),
      ],
      questions: [
        { q: "In (3, 5), the 3 is the…", options: ["x (along)", "y (up)", "colour", "size"], answer: "x (along)", explain: "First number = x." },
        { q: "Plot (0, 0) — this is the…", options: ["origin", "top corner", "middle of the night", "edge"], answer: "origin", explain: "Where axes cross." },
        { q: "'Along the corridor, up the stairs' means…", options: ["x first, then y", "y first, then x", "draw a circle", "guess"], answer: "x first, then y", explain: "Plot order." },
        { q: "Point (2, 6) is plotted…", options: ["2 along, 6 up", "6 along, 2 up", "2 up, 6 along", "at 0"], answer: "2 along, 6 up", explain: "x=2, y=6." },
        { q: "The horizontal axis is the…", options: ["x-axis", "y-axis", "origin", "grid"], answer: "x-axis", explain: "Left-right." },
      ],
    },
    {
      topic: "Coordinates & Graphs",
      ...
      minutes: 12,
      points: 80,
      summary: "A line graph shows how something changes over time; read the axes to find values.",
      blocks: [
        { type: "heading", text: "Change Over Time" },
        { type: "text", text: "A line graph shows how a value changes — usually over time. The bottom (x-axis) is often time (days, hours); the side (y-axis) is the thing being measured (temperature, height, sales). A line connects the points.\n\nRead it by finding a time on the x-axis, going UP to the line, then ACROSS to read the value on the y-axis. A rising line = increasing; a falling line = decreasing; flat = no change." },
        { type: "example", text: "A temperature graph: at 12 noon, go up to the line, then across → 20°C. The line rises in the afternoon = getting warmer." },
        { type: "keyPoints", items: ["Line graphs show change over time.", "x = time, y = value.", "Read: along, up, across.", "Rising = up, falling = down."] },
        mcq("A rising line on a graph means…", ["the value is increasing", "the value is zero", "nothing is happening", "it's broken"], "the value is increasing", "Upward trend."),
      ],
      questions: [
        { q: "A line graph is best for showing…", options: ["change over time", "favourite colours", "names", "a single number"], answer: "change over time", explain: "e.g. temperature." },
        { q: "On a line graph the x-axis is often…", options: ["time", "colour", "names", "feelings"], answer: "time", explain: "Days/hours." },
        { q: "A falling line means…", options: ["the value is decreasing", "increasing", "flat", "missing"], answer: "the value is decreasing", explain: "Downward trend." },
        { q: "To read a value: go along, then…", options: ["up to the line, then across", "down, then sleep", "in a circle", "across first"], answer: "up to the line, then across", explain: "Find the y-value." },
        { q: "A flat line means…", options: ["no change", "rising fast", "falling", "broken"], answer: "no change", explain: "Stays the same." },
      ],
    },
    {
      topic: "Coordinates & Graphs",
      title: "Pie Charts (Intro)",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "A pie chart shows parts of a whole as slices of a circle; the whole circle = 100%.",
      blocks: [
        { type: "heading", text: "Slices of a Whole" },
        { type: "text", text: "A pie chart shows how a total is split into parts, as slices of a circle. The WHOLE circle represents everything (100%). A bigger slice = a bigger share.\n\nIf half the class likes football, football's slice is half the circle (50%). A quarter likes reading → a 25% slice. All slices must add up to the full circle (100%)." },
        { type: "example", text: "Pets survey: dogs 50% (half the pie), cats 25% (quarter), fish 25% (quarter). The biggest slice = most popular." },
        { type: "keyPoints", items: ["Pie chart = parts of a whole.", "Whole circle = 100%.", "Bigger slice = bigger share.", "All slices add to 100%."] },
        mcq("A whole pie chart = ?", ["100%", "50%", "10 slices", "360 people"], "100%", "The whole."),
      ],
      questions: [
        { q: "A pie chart shows…", options: ["parts of a whole", "change over time", "one number", "coordinates"], answer: "parts of a whole", explain: "As slices." },
        { q: "The whole circle = ?", options: ["100%", "50%", "0%", "10%"], answer: "100%", explain: "Everything." },
        { q: "A bigger slice means…", options: ["a bigger share", "less", "nothing", "it's broken"], answer: "a bigger share", explain: "More of the total." },
        { q: "All pie slices add up to…", options: ["100%", "360 slices", "50%", "any number"], answer: "100%", explain: "The whole." },
        { q: "Half the circle = ?", options: ["50%", "25%", "100%", "10%"], answer: "50%", explain: "Half of 100." },
      ],
    },
    ...
    {
      topic: "Probability",
      title: "Words of Chance",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Probability uses words: impossible, unlikely, even chance, likely, certain.",
      blocks: [
        { type: "heading", text: "How Likely?" },
        { type: "text", text: "Probability is how likely something is to happen. We use words on a scale: IMPOSSIBLE (can never happen — rolling a 7 on a normal die), UNLIKELY (probably won't), EVEN CHANCE (50/50 — flipping heads), LIKELY (probably will), and CERTAIN (definitely will — the Sun will rise).\n\nThese words run from 0 (impossible) to 1 (certain), with even chance at ½." },
        { type: "example", text: "Rolling a 6 on a die: unlikely. Picking a red ball from a bag of only red balls: certain. A pig flying: impossible." },
        { type: "keyPoints", items: ["Impossible → 0, certain → 1.", "Even chance = ½ (50/50).", "Unlikely < ½; likely > ½.", "Scale from 0 to 1."] },
      ],
      questions: [
        { q: "Rolling a 7 on a normal 6-sided die is…", options: ["impossible", "certain", "likely", "even chance"], answer: "impossible", explain: "No 7 on a die." },
        { q: "Flipping heads on a coin is…", options: ["even chance", "impossible", "certain", "0"], answer: "even chance", explain: "50/50." },
        { q: "Even chance = ?", options: ["½ (50/50)", "0", "1", "100%"], answer: "½ (50/50)", explain: "Equal chances." },
        { q: "The Sun rising tomorrow is…", options: ["certain", "impossible", "unlikely", "even"], answer: "certain", explain: "Definitely." },
        { q: "Probability words run from…", options: ["0 (impossible) to 1 (certain)", "1 to 10", "A to Z", "never"], answer: "0 (impossible) to 1 (certain)", explain: "The scale." },
      ],
    },
    {
      topic: "Probability",
      ...
      minutes: 14,
      points: 90,
      summary: "Probability = (ways it can happen) ÷ (total outcomes), shown as a fraction.",
      blocks: [
        { type: "heading", text: "Counting Chances" },
        { type: "text", text: "Probability can be written as a fraction: the number of ways the thing CAN happen on top, and the total number of possible outcomes on the bottom.\n\nA bag has 3 red balls and 2 blue (5 total). Picking a red: 3/5. Picking a blue: 2/5. Picking a green: 0/5 = impossible. The top number is never bigger than the bottom." },
        { type: "example", text: "A spinner with 4 equal sections, 1 red: P(red) = 1/4. A die: P(rolling a 6) = 1/6. P(rolling an even) = 3/6 = ½." },
        { type: "keyPoints", items: ["P = ways ÷ total.", "Top = ways to win.", "Bottom = total outcomes.", "Ranges 0 to 1."] },
      ],
      questions: [
        { q: "Bag: 3 red, 2 blue. P(red) = ?", options: ["3/5", "2/5", "3/2", "5/3"], answer: "3/5", explain: "3 red of 5 total." },
        { q: "P(blue) in the same bag = ?", options: ["2/5", "3/5", "1/2", "2/3"], answer: "2/5", explain: "2 blue of 5." },
        { q: "P(rolling 6 on a normal die) = ?", options: ["1/6", "1/2", "6/1", "1/3"], answer: "1/6", explain: "One 6 of six faces." },
        { q: "P(green) from a bag of only red + blue = ?", options: ["0 (impossible)", "1/2", "1", "1/5"], answer: "0 (impossible)", explain: "No green balls." },
        { q: "Probability fractions range from…", options: ["0 to 1", "1 to 6", "0 to 100", "1 to 10"], answer: "0 to 1", explain: "0 = impossible, 1 = certain." },
      ],
    },
    {
      topic: "Probability",
      ...
      minutes: 12,
      points: 80,
      summary: "A fair chance gives equal odds; a biased one favours an outcome (like a loaded spinner).",
      blocks: [
        { type: "heading", text: "Fair or Foul?" },
        { type: "text", text: "A FAIR game or object gives every outcome an equal chance — a fair coin, a fair die, a spinner with equal sections. A BIASED one favours some outcomes, like a weighted die that lands on 6 too often, or a spinner whose blue section is bigger than the others.\n\nSpotting bias matters: if a coin lands heads 20 times in a row, it's probably not fair! Fair tests in science use the same idea — change one thing, keep everything else equal." },
        { type: "example", text: "A spinner with 5 equal sections = fair (each has 1/5). Make one section twice as big and it's biased toward that colour." },
        { type: "keyPoints", items: ["Fair = equal chances for all.", "Biased = favours an outcome.", "A weighted die is biased.", "Big uneven spinner = biased."] },
      ],
      questions: [
        { q: "A fair die gives each face a chance of…", options: ["1/6 (equal)", "different", "0", "1/2"], answer: "1/6 (equal)", explain: "Equal odds." },
        { q: "A spinner with one huge section is…", options: ["biased", "fair", "impossible", "broken"], answer: "biased", explain: "Favours that section." },
        { q: "A coin landing heads 20× running is probably…", options: ["biased/unfair", "fair", "impossible", "certain"], answer: "biased/unfair", explain: "Too unlikely by chance." },
        { q: "Fair means…", options: ["equal chances for all outcomes", "always heads", "one winner", "no rules"], answer: "equal chances for all outcomes", explain: "Even odds." },
        { q: "A weighted die is an example of…", options: ["a biased object", "a fair object", "an impossible one", "a coin"], answer: "a biased object", explain: "Favours a face." },
      ],
    },
  ],
};

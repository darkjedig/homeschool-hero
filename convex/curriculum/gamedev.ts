...
export const gamedev: SubjectCurriculum = {
  ...
  topics: [
    ...
    { name: "Game Audio", description: "Sound effects, music and balancing for atmosphere.", difficulty: "intermediate" },
    { name: "Level Design", description: "Designing fun levels, difficulty and testing.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== GAME LOOPS (4) =====================
    {
    ...
    {
      topic: "Game Audio",
      title: "Sound Effects That Sell It",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "Sound effects — jumps, hits, coins — make every action feel real and satisfying.",
      blocks: [
        { type: "heading", text: "Hear the Action" },
        { type: "text", text: "Good sound effects (SFX) make a game feel alive. Every important action needs a sound: a 'boing' for a jump, a 'crunch' for a hit, a 'ding' for a coin, a 'whoosh' for a swing. These sounds tell the player instantly that something happened — feedback for the ears.\n\nDesigners choose or record sounds that match the FEELING: a heavy enemy thuds; a tiny one pips. The right SFX can make even a simple shape feel powerful or fragile." },
        { type: "example", text: "Mario's coin sound (the rising two notes) is one of the most famous in gaming — it makes collecting coins feel rewarding." },
        { type: "keyPoints", items: ["SFX make actions feel real.", "Every key action needs a sound.", "Match the sound to the feeling.", "Sound = feedback for the ears."] },
      ],
      questions: [
        { q: "Sound effects mainly give…", options: ["instant feedback", "nothing", "the score only", "the story"], answer: "instant feedback", explain: "Confirm an action." },
        { q: "A coin collected usually plays a…", options: ["'ding' reward", "thunder", "silence", "siren"], answer: "'ding' reward", explain: "Positive feedback." },
        { q: "A heavy enemy should…", options: ["thud", "pip", "be silent", "squeak"], answer: "thud", explain: "Match the feel." },
        { q: "SFX stands for…", options: ["sound effects", "super fx", "special fixes", "score"], answer: "sound effects", explain: "Game audio." },
        { q: "Good SFX make a simple shape feel…", options: ["powerful or fragile", "invisible", "broken", "2D only"], answer: "powerful or fragile", explain: "Sound shapes feel." },
      ],
    },
    {
      topic: "Game Audio",
      ...
      minutes: 12,
      points: 80,
      summary: "Music sets the mood — calm for exploration, fast for danger — without drowning the action.",
      blocks: [
        { type: "heading", text: "Set the Mood" },
        { type: "text", text: "Background music (BGM) sets the EMOTION of a scene. A calm, slow tune suits exploring a peaceful village; a fast, tense track suits a boss battle; a spooky melody suits a dungeon. The music tells the player how to FEEL before they even see the danger.\n\nBalance matters: music should sit under the action, not fight it. If you can't hear the important SFX (a coin, a hit), the music is too loud. Many games fade or change the music as the mood shifts." },
        { type: "example", text: "A boss battle might switch from the gentle village tune to a fast, pounding track the moment the fight begins — instantly signalling danger." },
        { type: "keyPoints", items: ["BGM sets the mood/emotion.", "Calm = explore; fast = danger.", "Keep music under the SFX.", "Change music as mood shifts."] },
      ],
      questions: [
        { q: "Background music mainly sets the…", options: ["mood/emotion", "score", "controls", "frame rate"], answer: "mood/emotion", explain: "How to feel." },
        { q: "A boss battle suits…", options: ["fast, tense music", "calm music", "silence", "a lullaby"], answer: "fast, tense music", explain: "Signals danger." },
        { q: "Music that's too loud…", options: ["drowns out the SFX", "improves the game", "is required", "is always silent"], answer: "drowns out the SFX", explain: "Balance matters." },
        { q: "A peaceful village suits…", options: ["calm, slow music", "thumping rock", "sirens", "nothing"], answer: "calm, slow music", explain: "Relaxed mood." },
        { q: "Changing music as mood shifts…", options: ["signals what's happening", "is bad", "is impossible", "breaks the game"], answer: "signals what's happening", explain: "e.g. danger starts." },
      ],
    },
    {
      topic: "Game Audio",
      title: "Balancing Game Audio",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "Mix the audio so important sounds (SFX) are clear above the music; give players volume controls.",
      blocks: [
        { type: "heading", text: "The Audio Mix" },
        { type: "text", text: "A good AUDIO MIX balances everything so the player hears what matters. Important SFX (a coin, a hit, a warning) should be CLEAR above the music and ambient background. Voice (if any) sits on top. Each track has its own VOLUME level.\n\nAlways give players OPTIONS: separate volume sliders for master, music and SFX, plus a mute. Some players are sensitive to loud or sudden sound; a 'reduce loud sounds' option helps accessibility." },
        { type: "example", text: "If footsteps + music drown out the 'low health' warning beep, the player could die not knowing they were in danger — the mix failed." },
        { type: "keyPoints", items: ["Mix = balance all audio.", "Important SFX clear above music.", "Separate volume sliders.", "Add mute + accessibility options."] },
      ],
      questions: [
        { q: "The most important sounds should be…", options: ["clear above the music", "quieter than music", "muted", "removed"], answer: "clear above the music", explain: "So players hear them." },
        { q: "A good game offers…", options: ["separate volume sliders", "no controls", "only mute all", "fixed loud volume"], answer: "separate volume sliders", explain: "Master/music/SFX." },
        { q: "If music drowns a warning beep…", options: ["the player might miss the danger", "nothing happens", "the score rises", "the game speeds up"], answer: "the player might miss the danger", explain: "A bad mix." },
        { q: "'Accessibility' in audio means…", options: ["options for sensitive players", "loud only", "no sound", "one volume"], answer: "options for sensitive players", explain: "e.g. reduce loud sounds." },
        { q: "Voice in a game should sit…", options: ["on top of everything", "below music", "at the bottom", "muted always"], answer: "on top of everything", explain: "So it's heard." },
      ],
    },
    ...
    {
      topic: "Level Design",
      title: "Designing Fun Levels",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "A good level teaches a new idea safely, then tests it — with clear goals and fair challenges.",
      blocks: [
        { type: "heading", text: "Teach, Then Test" },
        { type: "text", text: "Great level design follows a simple rule: introduce a new idea SAFELY first (a room where you can't die while you learn), then TEST it (a room where the idea is used under pressure). Each level teaches something new — a jump, a mechanic, an enemy — then builds on it.\n\nGive players a clear GOAL (reach the door, collect the stars), fair challenges (death feels like your fault, not the game's), and landmarks so they always know where to go. Fun comes from clear, fair, satisfying challenges." },
        { type: "example", text: "A level might show you a new 'wall-jump' in a safe pit (no enemies), then later make you wall-jump over spikes — teaching before testing." },
        { type: "keyPoints", items: ["Teach a new idea safely first.", "Then test it under pressure.", "Clear goals + fair challenges.", "Landmarks guide the player."] },
      ],
      questions: [
        { q: "A good level ___ a new idea, then tests it.", options: ["teaches safely", "hides", "removes", "ignores"], answer: "teaches safely", explain: "Teach before test." },
        { q: "'Fair' challenge means…", options: ["death feels like your fault", "it's impossible", "it's too easy", "it's random"], answer: "death feels like your fault", explain: "Not the game's fault." },
        { q: "A level should have a clear…", options: ["goal", "font", "colour only", "name"], answer: "goal", explain: "Reach the door, etc." },
        { q: "Why teach safely first?", options: ["So the player learns without dying", "To waste time", "To make it hard", "No reason"], answer: "So the player learns without dying", explain: "Then test it." },
        { q: "Landmarks in a level…", options: ["guide the player where to go", "block the player", "do nothing", "add sound"], answer: "guide the player where to go", explain: "A big tower, a light, etc." },
      ],
    },
    {
      topic: "Level Design",
      ...
      minutes: 12,
      points: 80,
      summary: "A good game starts easy, gently ramps up, and saves the hardest bits for the end.",
      blocks: [
        { type: "heading", text: "Easy Then Harder" },
        { type: "text", text: "A DIFFICULTY CURVE is how hard a game gets over time. The best games start EASY (so the player learns without rage), then gently RAMP UP as skills grow, with small 'breather' breaks between hard bits. The very hardest challenges come near the end.\n\nIf a game is hard too soon, players quit in frustration; if it never gets harder, they get bored. The sweet spot keeps players stretched but never hopeless." },
        { type: "example", text: "The first level of a platformer might let you stroll to the goal; the last level throws everything at you. The middle builds up in between." },
        { type: "keyPoints", items: ["Start easy, ramp up gently.", "Add 'breather' breaks.", "Hardest bits near the end.", "Keep players stretched, not hopeless."] },
      ],
      questions: [
        { q: "A good difficulty curve…", options: ["starts easy and ramps up", "is hard from the start", "never changes", "is random"], answer: "starts easy and ramps up", explain: "Build skills first." },
        { q: "If a game is hard too soon…", options: ["players quit in frustration", "it's great", "it's too easy", "nothing"], answer: "players quit in frustration", explain: "Too punishing." },
        { q: "If a game never gets harder…", options: ["players get bored", "it's perfect", "players rage", "nothing"], answer: "players get bored", explain: "No challenge." },
        { q: "A 'breather' is…", options: ["an easier bit between hard ones", "the hardest part", "the end", "a pause menu"], answer: "an easier bit between hard ones", explain: "A rest." },
        { q: "The hardest challenges come…", options: ["near the end", "at the very start", "in the middle only", "never"], answer: "near the end", explain: "Where skills are best." },
      ],
    },
    {
      topic: "Level Design",
      title: "Testing & Player Feedback",
      difficulty: "intermediate",
      minutes: 14,
      points: 90,
      summary: "Watch real players test your level — where they get stuck shows you what to fix.",
      blocks: [
        { type: "heading", text: "Watch Real Players" },
        { type: "text", text: "No level is perfect first time. The best designers watch real players test their game and learn from where people struggle. If players keep dying in the same spot, the challenge is unfair or unclear. If they wander lost, the signs/landmarks aren't working. If they miss a key item, it's hidden too well.\n\nIterate: fix, test again, fix. Listen to feedback without ego — a confused player is telling you the level (not the player) has a problem." },
        { type: "example", text: "If 9 out of 10 testers fall into the same spike pit, the pit isn't a 'clever challenge' — it's a bad design. Move it, signpost it, or remove it." },
        { type: "keyPoints", items: ["Watch real testers play.", "Repeated stuck-points = a fix needed.", "Lost players = poor signposting.", "Iterate: fix, test, repeat."] },
      ],
      questions: [
        { q: "If testers keep dying in the same spot…", options: ["the level needs fixing there", "they're bad players", "it's fine", "remove the testers"], answer: "the level needs fixing there", explain: "Listen to data." },
        { q: "Lost players usually mean…", options: ["poor signposting", "a great level", "too easy", "too hard at the end"], answer: "poor signposting", explain: "Add landmarks." },
        { q: "Best way to improve a level?", options: ["watch real testers + iterate", "guess", "never change it", "ask no one"], answer: "watch real testers + iterate", explain: "Fix → test → repeat." },
        { q: "A confused player tells you…", options: ["the level has a problem", "they're clever", "the game is great", "nothing useful"], answer: "the level has a problem", explain: "Don't blame the player." },
        { q: "'Iterate' means…", options: ["fix, test, repeat", "give up", "ship it", "delete it"], answer: "fix, test, repeat", explain: "Improve in loops." },
      ],
    },
  ],
};

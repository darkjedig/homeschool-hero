...
export const homemaking: SubjectCurriculum = {
  slug: "homemaking",
  topics: [
    { name: "Money & Budgeting", description: "Pocket money, saving and smart spending.", difficulty: "intermediate" },
  ],
  lessons: [
    // ===================== COOKING BASICS (4) =====================
    {
    ...
    // ===================== NUTRITION & PLANNING (6) =====================
    {
      topic: "Recipes",
      title: "Balanced Meals & Food Groups",
      difficulty: "beginner",
      minutes: 12,
      points: 70,
      summary: "A balanced plate includes carbohydrates, protein, fruit/vegetables, and some dairy or alternatives — with limited sugar and salt.",
      blocks: [
        { type: "heading", text: "Fuel for Your Body" },
        { type: "text", text: "Carbohydrates (bread, rice, pasta) give energy. Protein (eggs, beans, chicken) builds and repairs muscle. Fruit and vegetables provide vitamins and fibre. Dairy or fortified alternatives give calcium for bones.\n\nThe Eatwell Guide suggests roughly: plenty of veg/fruit, some starchy carbs, some protein, small amounts of dairy, and occasional treats — not every meal needs meat." },
        { type: "example", text: "Balanced lunch: wholegrain wrap (carb) + chicken or hummus (protein) + salad (veg) + water." },
        { type: "keyPoints", items: ["Carbs = energy.", "Protein = growth/repair.", "Fruit/veg = vitamins + fibre.", "Balance, not perfection every meal."] },
        { type: "interactive", variant: "match", data: [
          { key: "Rice or pasta", value: "Carbohydrate — energy" },
          { key: "Eggs or beans", value: "Protein — growth and repair" },
          { key: "Broccoli or apple", value: "Fruit/vegetables — vitamins" },
          { key: "Milk or yoghurt", value: "Dairy — calcium for bones" },
        ]},
      ],
      questions: [
        { q: "Carbohydrates mainly provide…", options: ["energy", "only colour", "metal", "maps"], answer: "energy", explain: "Fuel for activity." },
        { q: "Protein helps…", options: ["build and repair muscle", "only sweeten food", "measure wood", "draw maps"], answer: "build and repair muscle", explain: "Body maintenance." },
        { q: "Calcium is important for…", options: ["strong bones", "computer code", "history dates", "wind direction"], answer: "strong bones", explain: "From dairy/alternatives." },
        { q: "Vegetables provide…", options: ["vitamins and fibre", "only sugar", "no nutrients", "electricity"], answer: "vitamins and fibre", explain: "Plant nutrients." },
        { q: "A balanced meal includes…", options: ["several food groups", "only sweets", "only water", "nothing"], answer: "several food groups", explain: "Variety matters." },
      ],
    },
    {
      topic: "Recipes",
      ...
      minutes: 12,
      points: 80,
      summary: "Pack labels show calories, fat, sugar, and salt per 100 g or per serving — compare similar products to choose wisely.",
      blocks: [
        { type: "heading", text: "Decode the Pack" },
        { type: "text", text: "Nutrition labels list energy (kcal/kJ), fat, saturates, sugar, and salt. 'Per 100 g' lets you compare different pack sizes fairly. 'Per serving' shows one portion — check if your portion matches!\n\nTraffic-light colours (green/amber/red) on some UK labels give a quick guide: green = low, red = high (for fat, sugar, salt)." },
        { type: "example", text: "Cereal A: 8 g sugar per 100 g. Cereal B: 22 g sugar per 100 g. A is lower sugar per 100 g." },
        { type: "keyPoints", items: ["Compare per 100 g.", "Check realistic serving size.", "Traffic lights: green lower, red higher.", "High sugar/salt = occasional treats."] },
        { type: "interactive", variant: "reveal", data: [
          { key: "question", value: "Why compare per 100 g?" },
          { key: "option_0", value: "Fair comparison between different pack sizes" },
          { key: "option_1", value: "To ignore all numbers" },
          { key: "option_2", value: "Because grams don't exist" },
          { key: "option_3", value: "Only for geography maps" },
          { key: "answer", value: "Fair comparison between different pack sizes" },
          { key: "explanation", value: "Standard unit for comparing foods." },
        ]},
      ],
      questions: [
        { q: "Per 100 g helps you…", options: ["compare products fairly", "avoid all food", "measure wood", "read maps"], answer: "compare products fairly", explain: "Standard basis." },
        { q: "Red traffic light on sugar means…", options: ["high sugar", "no sugar", "low sugar", "protein"], answer: "high sugar", explain: "UK label guide." },
        { q: "kcal on a label shows…", options: ["energy (calories)", "map scale", "history year", "tool weight"], answer: "energy (calories)", explain: "Energy content." },
        { q: "Always check if your portion…", options: ["matches the serving size listed", "is infinite", "is zero", "ignores label"], answer: "matches the serving size listed", explain: "Realistic portions." },
        { q: "High salt intake long-term can affect…", options: ["health (blood pressure)", "map colours only", "computer speed", "gravity"], answer: "health (blood pressure)", explain: "Moderation matters." },
      ],
    },
    {
      topic: "Cooking Basics",
      ...
      minutes: 12,
      points: 80,
      summary: "Plan meals ahead, write a shopping list from recipes, and prep ingredients to save time and reduce waste.",
      blocks: [
        { type: "heading", text: "Plan Once, Stress Less" },
        { type: "text", text: "Meal planning: pick 4–5 dinners for the week, check what you already have, write a shopping list for missing items, and note prep steps (chop veg Sunday → faster Monday).\n\nPlanning cuts impulse buys, reduces food waste, and makes balanced meals more likely than last-minute takeaways." },
        { type: "example", text: "Monday pasta, Tuesday stir-fry, Wednesday soup — shared veg on the list once, used twice." },
        { type: "keyPoints", items: ["Pick meals before shopping.", "List only what you need.", "Prep ahead when possible.", "Use leftovers safely."] },
        { type: "interactive", variant: "ordering", data: [
          { key: "1", value: "Choose meals for the week" },
          { key: "2", value: "Check cupboards and fridge" },
          { key: "3", value: "Write shopping list for gaps" },
          { key: "4", value: "Prep ingredients if time allows" },
        ]},
      ],
      questions: [
        { q: "Meal planning helps reduce…", options: ["food waste and stress", "all cooking forever", "nutrition", "shopping lists"], answer: "food waste and stress", explain: "Organised approach." },
        { q: "Before shopping you should…", options: ["check what you already have", "buy randomly", "ignore recipes", "skip lists"], answer: "check what you already have", explain: "Avoid duplicates." },
        { q: "Prep ahead might mean…", options: ["chopping veg in advance", "never cooking", "ignoring safety", "deleting recipes"], answer: "chopping veg in advance", explain: "Saves weekday time." },
        { q: "Leftovers should be…", options: ["stored safely and used promptly", "left out for days", "never reused", "mixed with cleaning fluid"], answer: "stored safely and used promptly", explain: "Fridge within 2 hours." },
        { q: "A shopping list from recipes…", options: ["targets what you actually need", "buys everything in the shop", "replaces cooking", "measures wood"], answer: "targets what you actually need", explain: "Focused shopping." },
      ],
    },
    {
      topic: "Kitchen Safety",
      title: "Food Storage & Leftovers",
      difficulty: "beginner",
      minutes: 10,
      points: 60,
      summary: "Cool food quickly, refrigerate within two hours, label dates, and reheat until steaming hot right through.",
      blocks: [
        { type: "heading", text: "Keep It Safe Overnight" },
        { type: "text", text: "Bacteria grow fast between 5 °C and 63 °C (the 'danger zone'). Put leftovers in the fridge within 2 hours. Store in clean containers, label with date, and eat within 2–3 days unless frozen.\n\nReheat once until piping hot (steaming, 75 °C core). Do not reheat rice unless it was cooled quickly and stored properly — rice can harbour Bacillus spores." },
        { type: "example", text: "Dinner at 6 pm → in fridge by 8 pm latest. Reheat lunch portion next day until steaming." },
        { type: "keyPoints", items: ["Fridge within 2 hours.", "Label and date containers.", "Reheat until steaming hot.", "Rice needs extra care."] },
        { type: "interactive", variant: "reveal", data: [
          { key: "question", value: "The 'danger zone' for bacterial growth is roughly…" },
          { key: "option_0", value: "5 °C to 63 °C" },
          { key: "option_1", value: "-50 °C to -40 °C" },
          { key: "option_2", value: "200 °C to 300 °C" },
          { key: "option_3", value: "No temperature effect" },
          { key: "answer", value: "5 °C to 63 °C" },
          { key: "explanation", value: "Warm room temp to lukewarm food." },
        ]},
      ],
      questions: [
        { q: "Leftovers should reach the fridge within…", options: ["2 hours", "24 hours", "1 week", "never"], answer: "2 hours", explain: "Limit bacteria growth." },
        { q: "Reheat leftovers until…", options: ["piping hot throughout", "lukewarm", "frozen", "room temp"], answer: "piping hot throughout", explain: "Kill bacteria." },
        { q: "Labelling containers with date helps…", options: ["use food while still safe", "ignore safety", "measure wood", "draw maps"], answer: "use food while still safe", explain: "Track freshness." },
        { q: "Rice leftovers need…", options: ["extra careful cooling and storage", "no rules", "only freezing forever", "never refrigerating"], answer: "extra careful cooling and storage", explain: "Bacillus risk." },
        { q: "The danger zone is where bacteria…", options: ["multiply quickly", "cannot exist", "freeze instantly", "become vitamins"], answer: "multiply quickly", explain: "5–63 °C." },
      ],
    },
    {
      topic: "Cleaning Routines",
      title: "Laundry Basics: Sort, Wash, Dry",
      difficulty: "beginner",
      minutes: 10,
      points: 60,
      summary: "Sort clothes by colour and fabric, read care labels, use the right temperature, and dry safely.",
      blocks: [
        { type: "heading", text: "Clean Clothes, Longer Life" },
        { type: "text", text: "Sort whites, darks, and colours to prevent dye transfer. Check care labels for temperature and tumble-dry rules. Zip zips and turn delicate items inside out.\n\nUse the correct detergent dose — too much leaves residue. Air-dry saves energy; tumble dry on low for items that allow it." },
        { type: "example", text: "Red sock in white load → pink whites. Always sort first!" },
        { type: "keyPoints", items: ["Sort by colour and fabric.", "Read care labels.", "Correct temperature.", "Don't overload the machine."] },
        { type: "interactive", variant: "match", data: [
          { key: "Whites pile", value: "Hotter wash usually OK" },
          { key: "Dark jeans", value: "Cold wash — reduce fading" },
          { key: "Care label symbol", value: "Tells max temperature" },
          { key: "Overloading drum", value: "Poor wash + strain on machine" },
        ]},
      ],
      questions: [
        { q: "Sorting laundry prevents…", options: ["dye transfer", "all washing", "maps", "cooking"], answer: "dye transfer", explain: "Red on white disaster." },
        { q: "Care labels show…", options: ["max temperature and drying rules", "history dates", "map scale", "game scores"], answer: "max temperature and drying rules", explain: "Fabric instructions." },
        { q: "Overloading the washing machine…", options: ["cleans poorly", "always improves results", "is required", "fixes all stains"], answer: "cleans poorly", explain: "Clothes need room." },
        { q: "Delicate items often need…", options: ["gentler cycle or lower heat", "boiling water always", "no detergent", "hammer"], answer: "gentler cycle or lower heat", explain: "Protect fabric." },
        { q: "Air-drying…", options: ["saves energy", "ruins all clothes always", "replaces sorting", "measures wood"], answer: "saves energy", explain: "Eco-friendly option." },
      ],
    },
    {
      topic: "Appliance Safety",
      title: "Activity: Kitchen & Home Safety Sort",
      difficulty: "beginner",
      minutes: 8,
      points: 80,
      summary: "Match household situations to the safest action.",
      kind: "activity",
      blocks: [
        { type: "heading", text: "Safe at Home" },
        { type: "text", text: "Match each situation to the best safe response." },
        match(
          ["Wet hands", "Dry before touching plugs or appliances"],
          ["Overloaded socket", "Unplug devices; spread load across sockets"],
          ["Smoking toaster", "Unplug at the wall; do not use water"],
          ["Knife dropped", "Step back; pick up safely — never try to catch"],
          ["Iron left on", "Switch off at wall; cool on a heat-safe stand"],
          ["Fridge door left open", "Close promptly to keep food cold"],
        ),
      ],
      questions: [],
    },
    ...
    // ===================== MONEY & BUDGETING (3) =====================
    {
      topic: "Money & Budgeting",
      title: "Pocket Money & Saving",
      difficulty: "intermediate",
      minutes: 12,
      points: 80,
      summary: "A budget plans money: some to spend, some to save, some to give — so you reach your goals.",
      blocks: [
        { type: "heading", text: "Plan Your Money" },
        { type: "text", text: "A budget is a plan for your money. When you get pocket money, decide before you spend it: some to SPEND now, some to SAVE for a bigger goal, and some to GIVE (a gift or charity). A simple rule is 'save a third, spend a third, share a third' — or pick your own split.\n\nSaving a little each week adds up. £3 a week saved for a year = over £150 toward something you really want." },
        { type: "example", text: "Pocket money £9/week: save £4, spend £4, give £1. After 10 weeks you've saved £40 — enough for that game." },
        { type: "keyPoints", items: ["A budget is a money plan.", "Split: spend, save, give.", "Small savings add up.", "Decide BEFORE you spend."] },
        match(["Budget", "A money plan"], ["Save", "Keep for a bigger goal"], ["Spend", "Use now"], ["Give", "Share with others"]),
      ],
      questions: [
        { q: "A budget is…", options: ["a money plan", "a recipe", "a cleaning tool", "a kind of food"], answer: "a money plan", explain: "Plan spend/save/give." },
        { q: "Saving means…", options: ["keeping money for later", "spending it all now", "losing it", "lending it"], answer: "keeping money for later", explain: "Toward a goal." },
        { q: "£3/week saved for a year is about…", options: ["£150+", "£30", "£3", "£1,000"], answer: "£150+", explain: "52 × 3." },
        { q: "A good habit is to decide…", options: ["before you spend", "after you've spent it", "never", "only at Christmas"], answer: "before you spend", explain: "Plan first." },
        { q: "'Spend, save, give' is a way to…", options: ["split your money", "wash dishes", "fold laundry", "cook rice"], answer: "split your money", explain: "A budget rule." },
      ],
    },
    {
      topic: "Money & Budgeting",
      ...
      minutes: 12,
      points: 80,
      summary: "Needs are essentials (food, shelter); wants are extras. Wise spenders cover needs first.",
      blocks: [
        { type: "heading", text: "Must-Have or Nice-to-Have?" },
        { type: "text", text: "A NEED is something you must have to live and be well: food, water, shelter, warm clothes, school supplies. A WANT is something nice but not essential: a new game, sweets, the latest trainers.\n\nSmart spenders cover NEEDS first, then decide which WANTS matter most with what's left. Asking 'need or want?' before buying stops impulse spending and helps your money go further." },
        { type: "example", text: "School shoes (need) vs sparkly light-up trainers (want). You need shoes; the sparkly upgrade is a want." },
        { type: "keyPoints", items: ["Needs = essentials to live/well.", "Wants = nice but not essential.", "Cover needs first.", "'Need or want?' stops impulse buys."] },
      ],
      questions: [
        { q: "Which is a NEED?", options: ["Food", "A new game", "Sweets", "A phone upgrade"], answer: "Food", explain: "Essential." },
        { q: "Which is a WANT?", options: ["Latest games console", "Water", "Shelter", "Warm coat"], answer: "Latest games console", explain: "Nice, not essential." },
        { q: "Wise spenders cover ___ first.", options: ["needs", "wants", "sweets", "impulses"], answer: "needs", explain: "Then wants." },
        { q: "Asking 'need or want?' helps you…", options: ["avoid impulse buys", "spend faster", "buy everything", "skip needs"], answer: "avoid impulse buys", explain: "Think before buying." },
        { q: "School books are a…", options: ["need", "want", "waste", "luxury"], answer: "need", explain: "Essential for learning." },
      ],
    },
    {
      topic: "Money & Budgeting",
      ...
      minutes: 12,
      points: 80,
      summary: "Compare prices, check for deals, and avoid impulse buys to make money go further.",
      blocks: [
        { type: "heading", text: "Get More for Your Money" },
        { type: "text", text: "Smart shopping means getting the best value. COMPARE PRICES across shops before buying. Check the UNIT PRICE (price per kg or per item) — bigger packs often cost less per unit. Watch for real DEALS, but beware tricks that make a 'sale' look better than it is.\n\nAvoid IMPULSE BUYS (things grabbed at the till). A 24-hour rule works well: wait a day before a bigger purchase; if you still want it, buy it." },
        { type: "example", text: "Cereal: small box £2 for 500g (40p/100g) vs big box £3.50 for 1kg (35p/100g). The big box is better value per unit." },
        { type: "keyPoints", items: ["Compare prices first.", "Check unit price (per kg/item).", "Beware fake 'sales'.", "Use a 24-hour rule on big buys."] },
      ],
      questions: [
        { q: "Before buying, you should…", options: ["compare prices", "grab the first one", "never check", "only look at colour"], answer: "compare prices", explain: "Shop around." },
        { q: "Unit price means…", options: ["price per kg/item", "total price", "sale price", "tax"], answer: "price per kg/item", explain: "For fair comparison." },
        { q: "An impulse buy is…", options: ["a sudden unplanned purchase", "a planned need", "a sale", "a saving"], answer: "a sudden unplanned purchase", explain: "Often regretted." },
        { q: "A '24-hour rule' helps you…", options: ["avoid impulse buys", "spend more", "skip needs", "buy faster"], answer: "avoid impulse buys", explain: "Wait and reconsider." },
        { q: "Bigger packs often…", options: ["cost less per unit", "cost more per unit", "are always worse", "have no unit price"], answer: "cost less per unit", explain: "Better value (usually)." },
      ],
    },
  ],
};
